...
// ─── 5 Problem → Engine → Solution Transformation Pairs for HQL ───────────────
...
const FLOW_ITEMS = [
  {
    ...
    num: '01',
    category: 'TARGETING',
    engineLabel: 'ICP Filter Hub',
    engineAction: 'Precision Scoring',
    problem: {
      title: 'Unfiltered Leads',
      sub: 'Broad Lists & Low Intent',
      icon: FilterX,
    },
    solution: {
      title: 'ICP Precision Fit',
      sub: 'Verified Technographic Stack',
      icon: Focus,
    },
    color: '#00A6FF',
  ...
  },
  {
    ...
    num: '02',
    category: 'AUTHORITY',
    engineLabel: 'Authority Scorer',
    engineAction: 'Seniority Audit',
    problem: {
      title: 'Junior Form Fills',
      sub: 'Zero Purchasing Power',
      icon: UserX,
    },
    solution: {
      title: 'Buying Committee Vetting',
      sub: 'VP & C-Suite Budget Holders',
      icon: Crown,
    },
    color: '#8B5CF6',
  ...
  },
  {
    ...
    engineAction: 'Triple-SMTP Cleanse',
    problem: {
      title: 'Stale Data & Bounces',
      sub: 'Domain Reputation Risk',
      icon: ShieldAlert,
    },
    solution: {
      title: '100% Verified Inboxes',
      sub: 'Zero Bounce SLA Guarantee',
      icon: FileCheck2,
    },
    color: '#10B981',
  ...
  },
  {
    id: 3,
    num: '04',
    category: 'DISCOVERY INTEL',
    engineLabel: 'Discovery Engine',
    engineAction: 'Bespoke Q&A Audit',
    problem: {
      title: 'Blind Sales Calls',
      sub: 'No Insight on Active Pain',
      icon: FileQuestion,
    },
    solution: {
      title: 'Custom Screening Answers',
      sub: 'Known Pain & Timelines',
      icon: ListChecks,
    },
    color: '#F59E0B',
  ...
  },
  {
    ...
    engineAction: 'Direct CRM Sync',
    problem: {
      title: 'SDR Pipeline Burnout',
      sub: '65%+ Rep Hours Wasted',
      icon: EyeOff,
    },
    solution: {
      title: 'Sales-Ready HQLs',
      sub: '3.8x Faster Close Rate',
      icon: BarChart3,
    },
    color: '#EC4899',
...
const WhatProblemsSolved = () => {
  ...
  const isProblemActive =
    phase === 'problem' || phase === 'toCenter' || phase === 'centerReact' || phase === 'toSolution' || phase === 'solution'
  ...
  return (
    <section
      ...
      aria-label="What Business Problems Does HQL Service Solve"
    >
      ...
      <div className="relative max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-4 sm:mb-5">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-tight leading-tight uppercase">
            <span>What Business Problems Does </span>
          ...
          <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 leading-relaxed max-w-xl mx-auto mt-1.5 font-normal">
            From unverified form fills to SDR burnout, we transform core pipeline bottlenecks into sales-ready conversations.
          </p>
        ...
        <div ref={containerRef} className="hidden md:block relative min-h-[380px] lg:min-h-[400px] w-full">
          ...
          >
            <defs>
              <filter id="line-glow-hql" x="-20%" y="-20%" width="140%" height="140%">
              ...
              {FLOW_ITEMS.map((item) => (
                <React.Fragment key={`arrow-${item.id}`}>
                  ...
                  <marker
                    id={`arrow-head-base-hql-${item.id}`}
                    viewBox="0 0 10 10"
                    refX="7"
                    refY="5"
                    markerWidth="5"
              ...
              return (
                <g key={`left-group-${i}`}>
                  ...
                  <path
                    ...
                    markerEnd={`url(#${isCurr && isLeftLineActive ? `arrow-head-hql-${item.id}` : `arrow-head-base-hql-${item.id}`})`}
                  />
              ...
              return (
                <g key={`right-group-${i}`}>
                  ...
                  <path
                    ...
                    markerEnd={`url(#${isCurr && isRightLineActive ? `arrow-head-hql-${item.id}` : `arrow-head-base-hql-${item.id}`})`}
                  />
            ...
            {paths.left[activeStep] && isLeftLineActive && !prefersReducedMotion && (
              <g>
                <animateMotion
                  ...
                  fill="freeze"
                />
                <circle r="8.5" fill={currentItem.color} opacity="0.35" filter="url(#line-glow-hql)" />
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="text-[12.5px] lg:text-[13px] font-bold text-slate-900 dark:text-white leading-tight truncate flex items-center justify-between">
                        ...
                        {isActive && (
                          <span
                            className="w-2 h-2 rounded-full animate-ping shrink-0 ml-1"
                            style={{ backgroundColor: item.color }}
                          />
                        )}
                      </div>
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      <div className="text-[8.5px] font-mono tracking-wider mt-0.5 text-center">
                        {phase === 'centerReact' ? (
                          <span className="text-amber-300 font-bold animate-pulse">⚡ QUALIFYING</span>
...
export default WhatProblemsSolved
