...
// 3 Core HQL Trust Pillars unified into the single animated button
const TRUST_PILLARS = [
  {
    id: 'targeted',
    label: 'ICP Targeted Leads',
    badge: 'TARGETED',
    icon: Radar,
    color: '#00A6FF',
  },
  {
    id: 'data',
    label: '100% Verified Decision Makers',
    badge: 'ZERO BOUNCE',
    icon: Shield,
    color: '#72D669',
  },
...
const HqlCTA = () => {
  ...
  return (
    <section
      ...
      aria-label="Ready to Turn High-Quality Leads Into Sales Conversations"
    >
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6 text-center">
        <motion.div style={prefersReducedMotion ? {} : { y }}>
          ...
          >
            Ready to Turn High-Quality Leads Into{' '}
            <span
          ...
          >
            Build targeted HQL campaigns around your ideal customers, verified decision-makers, custom discovery screening, and revenue goals.
          </motion.p>
          ...
          >
            ...
            >
              ...
              {/* Animated Text Cycler: ICP Targeted Leads → Verified Decision Makers → Vetted Buying Authority */}
