...
import WorkflowCanvas from './HqlWorkflow/WorkflowCanvas'
import WorkflowMobileView from './HqlWorkflow/WorkflowMobileView'
import { WORKFLOW_STEPS } from './HqlWorkflow/workflowData'
...
const HqlProcessWorkflow = () => {
  ...
  return (
    <section
      ...
      aria-label="How Our HQL Lead Generation Workflow Works"
    >
      ...
      <div className="relative max-w-[1380px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-5">
          ...
          {/* Main Title: HIGH-QUALITY LEADS (HQL) WORKFLOW */}
          <motion.div
          ...
          >
            A multi-stage qualification pipeline converting verified B2B decision-makers into sales-ready, high-intent meetings.
          </motion.p>
        </div>
...
export default HqlProcessWorkflow
