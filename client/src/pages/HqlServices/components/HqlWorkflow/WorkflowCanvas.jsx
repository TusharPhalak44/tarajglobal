  ...
  return (
    <div className="relative w-full max-w-[1300px] mx-auto">
      ...
      >
        ...
        {/* ── CARD 01: ICP & Account Mapping (Top Row, Left) ── */}
        <div
        ...
        {/* ── CARD 02: Decision-Maker Matrix (Top Row, Right) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '52.85%',
        ...
        {/* ── CARD 03: Data & Telephony Cleanse (Middle Row, Col 1) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '1.42%',
        ...
        {/* ── CARD 04: Pain-Centric Content (Middle Row, Col 2) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '18.57%',
        ...
        {/* ── CARD 05: Intent & Engagement Surge (Middle Row, Col 3) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '35.71%',
        ...
        {/* ── CARD 06: Discovery Screening Q&A (Middle Row, Col 4) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '52.85%',
        ...
        {/* ── CARD 07: Human QA Audit (Middle Row, Col 5) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '70.00%',
        ...
        {/* ── FINAL TARGET: QUALIFIED HQLS (Middle Row, Col 6) ── */}
        <div
        ...
        {/* ── CARD 08: CRM Lead Enrichment (Bottom Row, Left of 09) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '37.85%',
        ...
        {/* ── CARD 09: Pipeline Calibration (Bottom Row, Below 07) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '70.00%',
