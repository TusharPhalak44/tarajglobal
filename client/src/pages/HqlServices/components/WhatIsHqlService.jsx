...
const OUTCOME_INDICATORS = [
  ...
  },
  {
    num: '02',
    label: 'ENGAGE',
    desc: 'Measure problem-focused asset consumption',
    color: 'var(--cta)',
  ...
  },
  {
    num: '03',
    label: 'QUALIFY',
    desc: 'Score intent & deliver sales-ready leads',
    color: 'var(--success)',
...
const WhatIsHqlService = () => {
  ...
  return (
    <section
      ...
      aria-label="What is High-Quality Leads (HQL) Service"
    >
      {/* Background accents */}
      ...
      <div className="relative max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-8 lg:gap-10 items-center">
          ...
          <div className="relative">
            ...
            >
              <div className="relative aspect-[16/10] w-full overflow-hidden bg-surface">
                <img
                  src="/hql.png"
                  alt="High-Quality Leads (HQL) Journey: Target, Engage, Qualify"
          ...
          <div className="space-y-6">
            {/* PARAGRAPH REVEAL — independent staggered reveals */}
            <motion.p
            ...
            >
              A High-Quality Lead (HQL) is a prospective business buyer who has demonstrated meaningful intent in your
              solutions—through problem-centric content engagement or category research—and strictly matches your Ideal
            ...
            <motion.p
              ...
              className="text-sm sm:text-base text-text-secondary leading-relaxed"
            >
              Unlike raw, untargeted contacts or basic form fills, Taraj Global’s HQL service scores decision-maker
              authority, company fit, and active pain triggers before delivery. The result is sales-ready pipeline momentum
              that converts at dramatically higher velocity.
            </motion.p>
                ...
                {OUTCOME_INDICATORS.map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Description */}
                      <div className="text-xs sm:text-[13px] text-text-secondary leading-normal">{item.desc}</div>
                    </motion.div>
                  )
                })}
              </motion.div>
...
export default WhatIsHqlService
