...
import WorkflowCanvas from './WebinarProcessWorkflow/WorkflowCanvas'
import WorkflowMobileView from './WebinarProcessWorkflow/WorkflowMobileView'

const TOTAL_STEPS = 10
const STEP_DURATION_MS = 2200

const WebinarProcess = () => {
  ...
  return (
    <section
      ...
      aria-label="How Our B2B Webinar Process Works"
    >
