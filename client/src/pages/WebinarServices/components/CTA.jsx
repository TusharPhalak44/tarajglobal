...
const CTA = () => {
  ...
  return (
    <section
      ...
      aria-label="Ready to Turn Webinar Engagement Into Sales Opportunities"
    >
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6 text-center">
        <motion.div style={prefersReducedMotion ? {} : { y }}>
          ...
          >
            Ready to Turn Webinar Engagement Into{' '}
            <span
          ...
          >
            Reach relevant B2B audiences, engage decision-makers, and generate qualified opportunities with targeted webinar services from Taraj Global.
          </motion.p>
