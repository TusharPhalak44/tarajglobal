...
// ─── 6 Problem → Engine → Solution Transformation Pairs (Webinar Services) ───
...
const FLOW_ITEMS = [
  {
    ...
    engineLabel: 'Registration Engine',
    engineAction: 'Scale Verified Signups',
    problem: {
      title: 'Low Registrations',
      sub: 'Low Response & Empty Seats',
      icon: FilterX,
    },
    solution: {
  ...
  },
  {
    ...
    num: '02',
    category: 'TARGETING',
    engineLabel: 'ICP Audience AI',
    engineAction: 'Filter Right Audience',
    problem: {
      title: 'Wrong Audience Fit',
      sub: 'Unqualified Random Registrants',
      icon: MailX,
    },
    solution: {
  ...
  },
  {
    ...
    num: '03',
    category: 'ENGAGEMENT',
    engineLabel: 'Executive Reach',
    engineAction: 'Engage Senior Roles',
    problem: {
      title: 'Low Executive Turnout',
      sub: 'Junior Attendees Only',
      icon: ShieldAlert,
    },
    solution: {
      title: 'Decision-Maker Reach',
      sub: 'C-Suite & VP Attendance',
      icon: CheckCircle2,
    },
    color: '#10B981',
  ...
  },
  {
    ...
    engineLabel: 'Pipeline Engine',
    engineAction: 'Predictable Growth',
    problem: {
      title: 'Inconsistent Leads',
      sub: 'Sporadic Post-Event Pipeline',
      icon: Workflow,
    },
    solution: {
      title: 'Predictable Webinar Flow',
      sub: 'Systematic Opportunity Engine',
      icon: Send,
    },
    color: '#F59E0B',
  ...
  },
  {
    ...
    num: '05',
    category: 'VELOCITY',
    engineLabel: 'Handoff Hub',
    engineAction: 'Instant Lead Routing',
    problem: {
      title: 'Delayed Follow-Up',
      sub: 'Leads Go Cold in Days',
      icon: Clock,
    },
    solution: {
      title: 'Rapid Sales Handoff',
      sub: 'Immediate Meeting Booking',
      icon: Zap,
    },
    color: '#EC4899',
  ...
  },
  {
    ...
    engineLabel: 'Signal Validator',
    engineAction: 'Multi-Signal Scoring',
    problem: {
      title: 'Unqualified Leads',
      sub: 'Wasted Rep Follow-Up Time',
      icon: EyeOff,
    },
    solution: {
      title: 'Multi-Signal Qualification',
      sub: 'Sales-Ready High Intent',
      icon: BarChart3,
    },
    color: '#06B6D4',
...
const ProblemsSolved = () => {
  ...
  return (
    <section
      id="what-problems-webinar-services-solves"
      ref={sectionRef}
      ...
      aria-label="What Problems Do B2B Webinars Solve"
    >
      ...
      <div className="relative max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-4 sm:mb-5">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-tight leading-tight uppercase">
            <span>What Problems Do B2B </span>
          ...
          <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 leading-relaxed max-w-xl mx-auto mt-1.5 font-normal">
            From low attendance to slow post-event follow-up, we transform key webinar bottlenecks into predictable sales pipeline.
          </p>
        ...
        >
          ...
          >
            <defs>
              <filter id="webinar-line-glow" x="-20%" y="-20%" width="140%" height="140%">
              ...
              {FLOW_ITEMS.map((item) => (
                <React.Fragment key={`arrow-${item.id}`}>
                  ...
                  <marker
                    id={`webinar-arrow-head-base-${item.id}`}
                    viewBox="0 0 10 10"
                    refX="7"
                    refY="5"
                    markerWidth="5"
              ...
              return (
                <g key={`left-group-${i}`}>
                  ...
                  <path
                    ...
                    markerEnd={`url(#${isCurr && isLeftLineActive ? `webinar-arrow-head-${item.id}` : `webinar-arrow-head-base-${item.id}`})`}
                  />
              ...
              return (
                <g key={`right-group-${i}`}>
                  ...
                  <path
                    ...
                    markerEnd={`url(#${isCurr && isRightLineActive ? `webinar-arrow-head-${item.id}` : `webinar-arrow-head-base-${item.id}`})`}
                  />
            ...
            {paths.left[activeStep] && isLeftLineActive && !prefersReducedMotion && (
              <g>
                <animateMotion
                  ...
                  fill="freeze"
                />
                <circle r="8.5" fill={currentItem.color} opacity="0.35" filter="url(#webinar-line-glow)" />
          ...
          <div className="relative z-10 grid grid-cols-12 gap-2.5 lg:gap-3 items-center">
            ...
            {/* CENTER: Glowing Circular Transformation Engine */}
