...
export default function DevFinalCTA() {
  ...
  return (
    <section
      id="dev-final-cta"
      className="relative py-24 lg:py-32 bg-background border-t border-border/70 overflow-hidden text-center"
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-5 sm:px-8 lg:px-12 relative z-10">
        ...
        <p className="text-sm sm:text-base text-text-secondary leading-relaxed font-normal max-w-2xl mx-auto mb-10">
          Book a 20-minute strategy session with our senior pipeline architects. We will inspect your addressable market, map high-intent accounts, and formulate an executable outbound blueprint.
        </p>
