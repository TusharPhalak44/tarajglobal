...
const AUDIENCES = [
  {
    ...
    tagline: 'TECHNOLOGY DECISION MAKERS',
    color: '#00A6FF',
    image: '/saas-audience.jpg',
    description:
      'Engage CTOs, VP of Product, and engineering stakeholders across key high-ARR target accounts with multi-threaded, personalized ABM campaigns.',
    points: [
      'Account-level targeting filtered by verified tech stack and growth stage',
      'Messaging aligned to SaaS evaluation criteria, security audits, and POCs',
      'Multi-stakeholder touchpoints engaging both technical evaluators and finance heads',
    ],
    visualType: 'saas',
  },
  {
    ...
    tagline: 'TECH & ENGINEERING LEADERS',
    color: '#7C3AED',
    image: '/it-audience.jpg',
    description:
      'Connect with engineering directors, IT executives, and architecture leaders evaluating complex platform upgrades and cloud infrastructure.',
    points: [
      'Targeting verified IT leaders and system architects at named enterprise accounts',
      'Technical messaging highlighting deployment benchmarks, SLA reliability, and security',
      'Coordinated multi-touch outreach accelerating complex technical evaluations',
    ],
    visualType: 'it',
  },
  {
    ...
    tagline: 'ENTERPRISE BUYERS & PROCUREMENT',
    color: '#06B6D4',
    image: '/enterprise-audience.jpg',
    description:
      'Navigate multi-layered enterprise buying committees, procurement heads, and executive sponsors with tailored account-specific narratives.',
    points: [
      'Account-level mapping aligned to your Tier-1 enterprise target account lists (TAL)',
      'Messaging addressing executive ROI, procurement timelines, and compliance',
      'Strategic touches across C-suite sponsors and operational decision-makers',
    ],
  ...
  },
  {
    id: 'high-value',
    num: '04',
    label: 'High-Value B2B Businesses',
    tagline: 'HIGH-ACV BUSINESS SOLUTIONS',
    color: '#FF6D00',
    image: '/services-audience.jpg',
    description:
      'Focus marketing and sales resources where deal sizes justify bespoke, high-touch account campaigns designed to generate large ACV pipeline.',
    points: [
      'High-touch 1:1 and 1:few account campaign orchestration',
      'Custom bespoke content and personalized executive briefings',
      'Deep engagement tracking across key account committee members',
    ],
    visualType: 'services',
  },
  {
    id: 'long-cycles',
    num: '05',
    label: 'Companies With Long Sales Cycles',
    tagline: 'COMPLEX BUYING COMMITTEES',
    color: '#72D669',
    image: '/it-audience.jpg',
    description:
      'Sustain account momentum and keep buying committees aligned across 6 to 12-month enterprise evaluation cycles with steady, context-rich engagement.',
    points: [
      'Persistent, multi-channel touches that maintain account interest over long cycles',
      'Stage-specific content matching buying committee progression from discovery to contract',
      'Real-time intent telemetry alerting sales teams when buying interest spikes',
    ],
    visualType: 'it',
  },
  {
    ...
    num: '06',
    label: 'Businesses Targeting Specific Accounts',
    tagline: 'TIER-1 TARGET ACCOUNT LISTS',
    color: '#EC4899',
    image: '/enterprise-audience.jpg',
    description:
      'Penetrate tightly defined lists of must-win enterprise logos with surgical account intelligence, personalized messaging, and coordinated outreach.',
    points: [
      'Deep account intelligence profiling tech stack, org structure, and active initiatives',
      'Direct multi-channel engagement reaching key decision-makers within named logos',
      'Continuous qualification and warm sales handoff directly to account executives',
    ],
    visualType: 'enterprise',
  },
]
  ...
  if (type === 'it') {
    return (
      <svg
        ...
        fill="none"
      >
        <path d="M50 150 L150 90 L250 150 L150 210 Z" stroke={color} strokeWidth="1.5" />
        <path d="M50 170 L150 230 L250 170" stroke={color} strokeWidth="1.2" strokeDasharray="3 3" />
        <path d="M50 190 L150 250 L250 190" stroke={color} strokeWidth="1" />
        <circle cx="150" cy="90" r="6" fill={color} />
        <circle cx="50" cy="150" r="5" fill={color} />
        <circle cx="250" cy="150" r="5" fill={color} />
        <circle cx="150" cy="150" r="24" stroke={color} strokeWidth="1.5" />
        <line x1="150" y1="126" x2="150" y2="90" stroke={color} strokeWidth="1.5" />
      </svg>
    )
  }
  ...
  if (type === 'services') {
    return (
      <svg
        ...
        fill="none"
      >
        <circle cx="150" cy="150" r="100" stroke={color} strokeWidth="1" />
        <line x1="50" y1="150" x2="250" y2="150" stroke={color} strokeWidth="1" strokeDasharray="4 4" />
        <line x1="150" y1="50" x2="150" y2="250" stroke={color} strokeWidth="1" strokeDasharray="4 4" />
        <circle cx="150" cy="80" r="28" fill="var(--surface)" stroke={color} strokeWidth="1.5" />
        <circle cx="150" cy="74" r="9" stroke={color} strokeWidth="1.2" />
        <path d="M136 93 C136 85, 164 85, 164 93" stroke={color} strokeWidth="1.2" />
        <circle cx="215" cy="185" r="24" fill="var(--surface)" stroke={color} strokeWidth="1.5" />
        <circle cx="85" cy="185" r="24" fill="var(--surface)" stroke={color} strokeWidth="1.5" />
        <line x1="150" y1="108" x2="200" y2="165" stroke={color} strokeWidth="1.2" />
        <line x1="150" y1="108" x2="100" y2="165" stroke={color} strokeWidth="1.2" />
      </svg>
    )
  }
...
const WhoIsItFor = () => {
  ...
  const handleSelect = (idx) => {
    ...
    if (isDesktop && !prefersReducedMotion) {
      const st = ScrollTrigger.getById('who-is-it-for-abm-scroll')
      if (st) {
  ...
  return (
    <section
      ref={sectionRef}
      id="who-benefits-from-account-based-marketing"
      className="relative py-6 sm:py-8 lg:py-8 overflow-hidden bg-background"
      aria-label="Is Account-Based Marketing Right for You?"
    >
      {/* Background accents */}
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center mb-3.5 lg:mb-4">
          ...
          >
            Account-based marketing serves organizations looking to land high-value deals and engage complex buying committees.
            Select your profile to see how strategic ABM supports your revenue targets.
          </motion.p>
        </div>
        ...
        >
          <div className="grid md:grid-cols-12 gap-5 lg:gap-6 items-stretch">
            {/* LEFT SIDE: Vertical Stack of Selectable Audience Cards (4 cols on lg) */}
