...
import WorkflowCanvas from './AbmProcessWorkflow/WorkflowCanvas'
import WorkflowMobileView from './AbmProcessWorkflow/WorkflowMobileView'
...
const AbmProcess = () => {
  ...
  return (
    <section
      ...
      aria-label="How Our Account-Based Marketing Process Works"
    >
      ...
      <div className="relative max-w-[1380px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-5">
          ...
          {/* Main Title: ACCOUNT-BASED MARKETING WORKFLOW */}
          <motion.div
