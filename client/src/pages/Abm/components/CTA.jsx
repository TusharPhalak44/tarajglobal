...
const TRUST_PILLARS = [
  {
    id: 'targeted',
    label: 'Target Account Selection',
    badge: 'TARGETED',
    icon: Radar,
    color: '#00A6FF',
  },
    ...
    >
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6 text-center">
        <motion.div style={prefersReducedMotion ? {} : { y }}>
          ...
          >
            Ready to Turn Target Accounts Into{' '}
            <span
          ...
          >
            Build focused account-based marketing campaigns around verified high-yield accounts, buying committees, personalized messaging, and revenue goals.
          </motion.p>
