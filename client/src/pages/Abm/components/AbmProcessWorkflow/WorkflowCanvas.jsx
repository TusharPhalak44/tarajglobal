  ...
  return (
    <div className="relative w-full max-w-[1300px] mx-auto">
      ...
      >
        ...
        {/* ── CARD 01: Identify Accounts (Top Row, Left) ── */}
        <div
        ...
        {/* ── CARD 02: Account Research (Top Row, Right) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '52.85%',
        ...
        {/* ── CARD 03: Map Decision-Makers (Middle Row, Col 1) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '1.42%',
        ...
        {/* ── CARD 04: Content & Personalize (Middle Row, Col 2) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '18.57%',
        ...
        {/* ── CARD 05: Multi-Channel Engage (Middle Row, Col 3) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '35.71%',
        ...
        {/* ── CARD 07: Account Qualification (Middle Row, Col 5) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '70.00%',
        ...
        {/* ── CARD 08: Create Opportunities (Bottom Row, Left) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '37.85%',
