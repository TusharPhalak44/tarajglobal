...
const PILLARS = [
  {
    num: '01',
    title: 'Targeted Account Selection',
    desc: 'Campaigns built around verified high-yield accounts matching your exact ICP criteria. Every outreach decision is grounded in deep firmographic fit.',
    icon: Crosshair,
    bgImage: '/light 3.png',
  ...
  },
  {
    ...
    desc: 'Direct access to mapped buying committees, key budget holders, and internal champions instead of broad untargeted contact lists.',
    icon: Briefcase,
    bgImage: '/light 3.png',
    darkBgImage: '/dark 3.png',
  },
  {
    ...
    desc: 'Account-specific, 1-to-1 executive messaging tailored by industry context, role priorities, and real enterprise initiatives.',
  ...
  {
    num: '04',
    title: 'Account & Intent Intelligence',
    desc: 'Multi-channel intent monitoring and engagement telemetry across touchpoints to identify accounts showing active buying surges.',
    icon: PieChart,
    bgImage: '/light 3.png',
    darkBgImage: '/dark 3.png',
  },
  {
    ...
    desc: 'Focus on sales-ready qualified accounts and high-value opportunities that accelerate deal velocity and pipeline conversion.',
    icon: CheckCheck,
    bgImage: '/light 3.png',
    darkBgImage: '/dark 3.png',
  },
...
const WhyChoose = () => {
  ...
  return (
    <section
      id="why-choose-taraj-global-abm"
      ...
      aria-label="Why Choose Taraj Global for Account-Based Marketing"
    >
      ...
      <div className="relative max-w-[1560px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-6">
          ...
          >
            Targeted ABM campaigns that generate qualified accounts and meaningful executive sales conversations.
          </motion.p>
        </div>
