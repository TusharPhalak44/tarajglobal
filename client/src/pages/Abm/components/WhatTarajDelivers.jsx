...
const ENGINE_LAYERS = [
  {
    num: '01',
    layer: '01 — SELECTION',
    title: 'DemandFlow Bridge — Target Account Selection',
    shortTitle: 'Account Selection',
    tag: 'FIRMO & INTENT TIERING',
    module: 'DemandFlow Bridge — Account Selector',
    subLabel: 'High-Yield Enterprise ICP Engine',
    screen: 'Target Account Scoring & Selection Matrix',
    metric: 'PRECISION FIRMOGRAPHICS • INTENT SURGE • ICP SCORING',
    desc: 'Define and tier high-yield enterprise accounts based on firmographics and live intent data.',
    icon: Layers,
    image: '/demandflow-admin.png',
    points: [
      'Firmographic & technographic ICP modeling',
      'Account tiering by revenue and market fit',
      'First-party & third-party intent filter',
      'Target account list harmonization',
    ],
  },
  {
    num: '02',
    layer: '02 — RESEARCH',
    title: 'DemandFlow Bridge — Account Research & Insights',
    shortTitle: 'Account Research',
    tag: 'DEEP ACCOUNT INTELLIGENCE',
    module: 'DemandFlow Bridge — Account Dossiers',
    subLabel: 'Organizational Intelligence System',
    screen: 'Deep Account Dossier & Tech Stack Profile',
    metric: 'COMPLETE DOSSIER • TECH STACK AUDIT • PAIN POINT MAPPING',
    desc: 'Deep account dossiers covering organizational structure, tech stacks, and operational pain points.',
    icon: ShieldCheck,
    image: '/demandflow-dbms.png',
    points: [
      'Comprehensive organizational structure mapping',
      'Installed technology stack detection',
      'Strategic business pain point identification',
      'Trigger event and leadership change alerts',
    ],
  },
  {
    num: '03',
    layer: '03 — STAKEHOLDERS',
    title: 'DemandFlow Bridge — Decision-Maker Mapping',
    shortTitle: 'Decision-Makers',
    tag: 'BUYING COMMITTEE INTELLIGENCE',
    module: 'DemandFlow Bridge — Org Chart Mapper',
    subLabel: 'Stakeholder & Committee Architecture',
    ...
    points: [
      ...
      'Direct dial and verified email validation',
      'Budget holder and influencer role categorization',
      'Cross-departmental stakeholder mapping',
    ],
  },
  {
    num: '04',
    layer: '04 — INTELLIGENCE',
    title: 'DemandFlow Bridge — Buyer Intelligence',
    shortTitle: 'Buyer Intelligence',
    tag: 'PRIORITIES & TRIGGERS',
    module: 'DemandFlow Bridge — Buyer Insights Hub',
    subLabel: 'Role-Specific Priority Engine',
    screen: 'Buyer Persona Matrix & Value Propositions',
    metric: 'BEHAVIORAL TRIGGERS • RELEVANCE INDEX • ICP MATCH',
    desc: 'Understand buyer priorities, trigger events, and account-specific challenges before outreach.',
    icon: Sparkles,
    image: '/demandflow-personalization.png',
    points: [
      'Persona-specific pain point extraction',
      'Strategic priority & budget cycle insights',
      'Contextual value proposition alignment',
      'Objection pre-emption intelligence',
    ],
  },
  {
    num: '05',
    layer: '05 — PERSONALIZATION',
    title: 'DemandFlow Bridge — Personalized Outreach',
    shortTitle: 'Personalization',
    tag: '1:1 BESPOKE MESSAGING',
    module: 'DemandFlow Bridge — Executive Copy Engine',
    subLabel: 'Dynamic 1:1 Narrative Generator',
    screen: 'Dynamic Executive Copy & Personalization Variables',
    metric: '1:1 EXECUTIVE COPY • 95.8% RELEVANCE MATCH',
    desc: 'Craft bespoke, 1-to-1 messaging and custom value narratives for each stakeholder persona.',
    icon: MailCheck,
    image: '/demandflow-campaigns.png',
    points: [
      'Hyper-personalized executive messaging',
      'Account-tailored content and case assets',
      'Dynamic tokens referencing real account initiatives',
      'Multi-touch narrative continuity',
    ],
  },
  {
    num: '06',
    layer: '06 — MULTI-CHANNEL',
    title: 'DemandFlow Bridge — Multi-Channel Engagement',
    shortTitle: 'Multi-Channel',
    tag: 'SYNCHRONIZED ORCHESTRATION',
    module: 'DemandFlow Bridge — Omnichannel Orchestrator',
    subLabel: 'Cross-Channel Cadence Hub',
    screen: 'Omnichannel Outreach Orchestration Matrix',
    metric: 'MULTI-TOUCH SYNC • EMAIL + LINKEDIN + TARGETED TOUCH',
    desc: 'Synchronized outreach across email, LinkedIn, and high-impact digital executive touchpoints.',
    icon: Gauge,
    image: '/demandflow-sequences.png',
    points: [
      'Coordinated email and LinkedIn cadences',
      'High-impact personalized executive touchpoints',
      'Smart cadence pacing and follow-up loops',
      'Reputation-safe deliverability controls',
    ],
  },
  {
    num: '07',
    layer: '07 — INTENT SIGNALS',
    title: 'DemandFlow Bridge — Intent Signal Tracking',
    shortTitle: 'Intent Tracking',
    tag: 'REAL-TIME SURGE TELEMETRY',
    module: 'DemandFlow Bridge — Intent Radar',
    subLabel: 'Account Behavioral Telemetry',
    screen: 'Account Intent Surges & Engagement Telemetry',
    metric: 'REAL-TIME INTENT SURGES • TOPIC CONSUMPTION TELEMETRY',
    desc: 'Real-time monitoring of account-level engagement, asset consumption, and intent surges.',
    icon: TrendingUp,
    image: '/demandflow-tracking.png',
    points: [
      'First-party engagement signal tracking',
      'Content interaction and asset view telemetry',
      'Third-party surge topic detection',
      'Real-time account heat score updates',
    ],
  },
  {
    num: '08',
    layer: '08 — QUALIFICATION',
    title: 'DemandFlow Bridge — Account Qualification & Scoring',
    shortTitle: 'Account Scoring',
    tag: 'BANT & BUYING READINESS',
    module: 'DemandFlow Bridge — Qualification Engine',
    subLabel: 'Readiness & Intent Validator',
    screen: 'Account Readiness & Scoring Dashboard',
    metric: 'QUALIFIED ACCOUNTS • 94.2% BANT COMPLIANCE',
    desc: 'Score accounts on engagement depth, committee interaction, and buying stage readiness.',
    icon: BadgeCheck,
    image: '/demandflow-qualification.png',
    points: [
      'Multi-stakeholder engagement scoring',
      'BANT and MEDDPICC criteria validation',
      'Intent threshold verification',
      'High-velocity sales readiness grading',
    ],
  },
  {
    num: '09',
    ...
    tag: 'CRM SYNC & PIPELINE ACCELERATION',
    module: 'DemandFlow Bridge — Pipeline Integrator',
    subLabel: 'Direct CRM & Rep Handoff',
    screen: 'Sales Handoff Briefing & CRM Integration Flow',
    metric: 'SALES-READY BRIEFS • INSTANT CRM SYNC • DEAL VELOCITY',
    desc: 'Deliver fully briefed, sales-ready accounts directly to your sales team with seamless CRM sync.',
    icon: Cpu,
    image: '/demandflow-admin.png',
    points: [
      'Comprehensive executive briefing dossiers',
      'Bi-directional HubSpot & Salesforce CRM synchronization',
      'Seamless meeting booking and account transfer',
      'Post-handoff pipeline tracking & attribution',
    ],
  },
]
      ...
      <div className="relative max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-6">
          ...
          <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 leading-relaxed max-w-2xl mx-auto mt-2 font-normal">
            Taraj Global delivers end-to-end Account-Based Marketing powered by DemandFlow Bridge, converting high-value target accounts into pipeline.
          </p>
        </div>
        ...
        <div className="relative rounded-3xl p-4 sm:p-5 md:p-6 bg-white dark:bg-[#0B1424] border border-slate-200/90 dark:border-white/10 shadow-xl dark:shadow-[0_20px_60px_rgba(0,0,0,0.6)] backdrop-blur-xl">
          ...
          {/* ── 1. HORIZONTAL CONNECTED 9-STAGE STEPPER RAIL ── */}
          <div
            ref={tabRailRef}
          ...
          {/* ── 2. TWO-COLUMN INTERACTIVE CONTENT & DEMANDFLOW BRIDGE SHOWCASE ── */}
