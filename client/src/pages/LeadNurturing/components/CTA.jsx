...
const TRUST_PILLARS = [
  ...
  {
    id: 'cadence',
    label: 'Multi-Touch Nurture Cadence',
    badge: 'MULTI-TOUCH',
    icon: Shield,
    color: '#72D669',
  },
...
const CTA = () => {
  ...
  return (
    <section
      ...
      aria-label="Ready to Nurture More B2B Opportunities"
    >
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6 text-center">
        <motion.div style={prefersReducedMotion ? {} : { y }}>
          ...
          >
            Engage the right prospects, strengthen buyer relationships, and move qualified opportunities closer to sales with targeted B2B lead nurturing.
          </motion.p>
          ...
          >
            ...
            >
              ...
              {/* Animated Text Cycler: Behavioral Scoring → Multi-Touch Cadence → Sales-Ready Leads */}
