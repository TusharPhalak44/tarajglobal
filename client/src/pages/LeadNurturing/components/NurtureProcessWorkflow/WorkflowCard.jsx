    ...
    >
      ...
      <div className="flex items-center justify-between gap-1 w-full mb-1">
        ...
        <div className="flex items-center gap-1.5 min-w-0">
          <span
            className={`font-mono text-xs sm:text-[13px] font-black tracking-wider transition-colors duration-300 shrink-0 ${isActive
        ...
        {/* Step Icon */}
        <div
          className={`relative p-1 rounded-lg transition-all duration-300 shrink-0 ${isActive
        ...
        >
          <IconComponent
            className={`w-3.5 h-3.5 sm:w-4 sm:h-4 transition-transform duration-300 ${isActive ? 'scale-110' : 'group-hover:scale-105'
              }`}
            strokeWidth={1.8}
          />
        </div>
      ...
      <div className="flex-1 flex flex-col justify-start overflow-hidden pt-0.5">
        <h3
          className={`font-heading font-bold text-[11px] sm:text-[11.5px] xl:text-[12px] leading-tight mb-0.5 tracking-tight transition-colors duration-300 ${isActive
