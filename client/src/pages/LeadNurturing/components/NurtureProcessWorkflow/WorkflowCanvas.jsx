...
export default function WorkflowCanvas({
  ...
  const step01 = WORKFLOW_STEPS.find((s) => s.id === '01') // 01 Identify
  const step02 = WORKFLOW_STEPS.find((s) => s.id === '02') // 02 Segment
  const step03 = WORKFLOW_STEPS.find((s) => s.id === '03') // 03 Touchpoints
  const step04 = WORKFLOW_STEPS.find((s) => s.id === '04') // 04 Engage
  const step05 = WORKFLOW_STEPS.find((s) => s.id === '05') // 05 Educate
  const step06 = WORKFLOW_STEPS.find((s) => s.id === '06') // 06 Telemetry
  const step07 = WORKFLOW_STEPS.find((s) => s.id === '07') // 07 Score
  const step08 = WORKFLOW_STEPS.find((s) => s.id === '08') // 08 Qualify
  const step09 = WORKFLOW_STEPS.find((s) => s.id === '09') // 09 Deliver
  ...
  return (
    <div className="relative w-full max-w-[1300px] mx-auto">
      ...
      >
        ...
        {/* ── CARD 03: Touchpoints (Middle Row, Col 1) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '1.42%',
        ...
        {/* ── CARD 04: Engage (Middle Row, Col 2) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '18.57%',
        ...
        {/* ── CARD 05: Educate (Middle Row, Col 3) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '35.71%',
        ...
        {/* ── CARD 06: Telemetry (Middle Row, Col 4) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '52.85%',
        ...
        {/* ── CARD 07: Score (Middle Row, Col 5) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '70.00%',
        ...
        {/* ── FINAL TARGET: SALES-READY OPPORTUNITIES (Middle Row, Col 6) ── */}
        <div
        ...
        {/* ── CARD 08: Qualify (Bottom Row, Left of 09) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '37.85%',
        ...
        {/* ── CARD 09: Deliver (Bottom Row, Below 07) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '70.00%',
