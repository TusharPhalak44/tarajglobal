...
export default function WorkflowTargetBadge({
  ...
  return (
    <div
      ...
      title="Click to celebrate Sales-Ready Opportunities!"
    >
      ...
      {/* ── CELEBRATION BLAST: 360-Degree Confetti & Sparkles Explosion on Click or Active ── */}
      ...
      {/* ── Main Circular Core Container (Completely Borderless) ── */}
      <motion.div
        ...
        `}
        style={{
          background: isCelebrated || clickBurstKey > 0
      ...
      >
        {/* ── Center Icon: Target or Celebration Trophy ── */}
        ...
        <div className="space-y-0 z-10 leading-tight">
          ...
          <span className="block text-sky-200 dark:text-[#00f0ff] font-black text-[9.5px] sm:text-[10.5px] xl:text-[11.5px] tracking-wider uppercase drop-shadow-[0_0_6px_rgba(0,240,255,0.7)]">
            OPPORTUNITIES
          </span>
        </div>
