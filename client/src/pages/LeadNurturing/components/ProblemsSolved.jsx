...
// ─── 5 Problem → Engine → Solution Transformation Pairs (Lead Nurturing) ─────
...
const FLOW_ITEMS = [
  {
    ...
    num: '01',
    category: 'ENGAGEMENT',
    engineLabel: 'Intent Discovery',
    engineAction: 'Lifecycle Cadence',
    problem: {
      title: 'Unengaged Prospects',
      sub: 'Cold Contacts Stalled in Pipeline',
      icon: FilterX,
    },
    solution: {
      title: 'Active Buyer Engagement',
      sub: 'Contextual Persona Touchpoints',
      icon: Focus,
    },
    color: '#00A6FF',
  ...
  },
  {
    ...
    engineAction: 'Pipeline Acceleration',
    problem: {
      title: 'Long Sales Cycles',
      sub: 'Stalled Buying Committees & Drag',
      icon: Clock,
    },
    solution: {
      title: 'Accelerated Deal Cycles',
      sub: 'Decision Support & Momentum',
      icon: Zap,
    },
    color: '#8B5CF6',
  ...
  },
  {
    ...
    engineLabel: 'Lifecycle Reactivator',
    engineAction: 'Dormant Lead Recovery',
    problem: {
      title: 'Lost Marketing Leads',
      sub: 'Leaking Top-of-Funnel Pipeline',
      icon: ShieldAlert,
    },
    solution: {
  ...
  },
  {
    ...
    num: '04',
    category: 'CADENCE',
    engineLabel: 'Automation Hub',
    engineAction: 'Trigger-Based Cadence',
    problem: {
      title: 'Inconsistent Follow-Up',
      sub: 'Follow-up Gaps & Missed Windows',
      icon: Workflow,
    },
    solution: {
      title: 'Structured Cadence',
      sub: 'Timely Outreach & Follow-Through',
      icon: Send,
    },
    color: '#F59E0B',
  ...
  },
  {
    ...
    num: '05',
    category: 'CONVERSION',
    engineLabel: 'Scoring Engine',
    engineAction: 'Sales-Ready Validation',
    problem: {
      title: 'Low Conversion Rates',
      sub: 'Unqualified Contacts Passing to Sales',
      icon: EyeOff,
    },
    solution: {
      title: 'High-Intent Opportunities',
      sub: 'Qualified Sales Readiness',
      icon: BarChart3,
    },
    color: '#EC4899',
...
// ─── Timing Constants (Smooth, Measured Pace) ────────────────────────────────
...
const ProblemsSolved = () => {
  ...
  return (
    <section
      id="what-problems-lead-nurturing-solves"
      ref={sectionRef}
      ...
      aria-label="What Problems Does Lead Nurturing Solve"
    >
      ...
      <div className="relative max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-4 sm:mb-5">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-tight leading-tight uppercase">
            ...
            <span className="bg-gradient-to-r from-primary via-[#00c8ff] to-cta bg-clip-text text-transparent">
              Lead Nurturing Solve?
            </span>
          </h2>

          <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 leading-relaxed max-w-xl mx-auto mt-1.5 font-normal">
            From unengaged prospects to long sales cycles, we transform core bottlenecks into sales ready conversations.
          </p>
        ...
        >
          ...
          >
            <defs>
              <filter id="ln-line-glow" x="-20%" y="-20%" width="140%" height="140%">
              ...
              return (
                <g key={`left-group-${i}`}>
                  ...
                  <path
                    ...
                    markerEnd={`url(#${isCurr && isLeftLineActive ? `ln-arrow-head-${item.id}` : `ln-arrow-head-base-${item.id}`})`}
                  />
              ...
              return (
                <g key={`right-group-${i}`}>
                  ...
                  <path
                    ...
                    markerEnd={`url(#${isCurr && isRightLineActive ? `ln-arrow-head-${item.id}` : `ln-arrow-head-base-${item.id}`})`}
                  />
                  {/* Animated Electric Pulse Flow on active line */}
            ...
            {paths.left[activeStep] && isLeftLineActive && !prefersReducedMotion && (
              <g>
                ...
                />
                {/* Outer halo */}
                <circle r="8.5" fill={currentItem.color} opacity="0.35" filter="url(#ln-line-glow)" />
                {/* Mid glow */}
