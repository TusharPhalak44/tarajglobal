...
import WorkflowCanvas from './NurtureProcessWorkflow/WorkflowCanvas'
import WorkflowMobileView from './NurtureProcessWorkflow/WorkflowMobileView'
import { WORKFLOW_STEPS } from './NurtureProcessWorkflow/workflowData'
...
const NurtureProcess = () => {
  ...
  return (
    <section
      ...
      aria-label="How Our B2B Lead Nurturing Process Works"
    >
      ...
      <div className="relative max-w-[1380px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-5">
          ...
          {/* Main Title: B2B LEAD NURTURING WORKFLOW */}
          <motion.div
          ...
          <motion.p
            ...
            className="text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed max-w-3xl mx-auto mt-3 font-normal"
          >
            How Our B2B Lead Nurturing Process Works: A structured, data-driven approach to engaging prospects, tracking buyer intent signals, and delivering sales-ready opportunities.
          </motion.p>
        </div>
