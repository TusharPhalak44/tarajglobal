...
// ─── 5 Problem → Engine → Solution Transformation Pairs (Database Cleansing) ───
...
const FLOW_ITEMS = [
  {
    ...
    engineLabel: 'Data Refresh Engine',
    engineAction: 'Active Employment Validation',
    problem: {
      title: '25-30% Annual Decay',
      sub: 'Stale records corroding outbound ROI',
      icon: AlertCircle,
    },
    solution: {
      title: 'Continuous Scrubbing',
  ...
  },
  {
    ...
    engineLabel: 'SMTP Live Ping Engine',
    engineAction: 'Dead Mailbox & Trap Purge',
    problem: {
  ...
  },
  {
    id: 2,
    num: '03',
    category: 'CRM EFFICIENCY',
    engineLabel: 'Deduplication Hub',
    engineAction: 'Intelligent Account Merging',
    problem: {
      title: 'Duplicate & Split Leads',
      sub: 'Multiple reps pitching same accounts',
      icon: Trash2,
    },
    solution: {
      title: 'Unified Master Account Keys',
  ...
  },
  {
    id: 3,
    num: '04',
    category: 'LOST CHAMPIONS',
    engineLabel: 'Turnover Interception',
    engineAction: 'Executive Job Move Tracking',
    problem: {
      title: 'Lost Champions on Turnover',
      sub: 'Past buyers switching firms unnoticed',
      icon: RefreshCw,
    },
    solution: {
      title: 'Job Change Track & Retarget',
  ...
  },
  {
    ...
    engineLabel: 'Enrichment Telemetry Core',
    engineAction: 'Direct Dial & Tech Appending',
    problem: {
      title: 'Incomplete Profiles & No Dials',
      sub: 'Missing cell numbers and tech stack',
      icon: Database,
    },
    solution: {
