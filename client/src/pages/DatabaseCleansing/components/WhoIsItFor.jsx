...
const AUDIENCES = [
  {
    id: 'revops',
    num: '01',
    label: 'RevOps & Marketing Operations',
    tagline: 'ELIMINATE DUPLICATES & CRM BLOAT',
    color: '#00A6FF',
    image: '/saas-audience.jpg',
    description:
      'Built for RevOps managers wrestling with bloated CRM contact tiers (HubSpot and Salesforce pricing penalties) and inaccurate attribution caused by duplicate records.',
    points: [
      'Automated fuzzy matching deduplication merging leads, contacts and accounts',
      'Standardized firmographics, revenue tiers, and lifecycle stages',
      'Significant CRM storage cost reductions and pristine attribution reports',
    ],
    visualType: 'revops',
  },
  {
    id: 'sales',
    num: '02',
    label: 'Outbound SDR Leadership',
    tagline: 'STOP CALLING DEPARTED BUYERS',
    color: '#7C3AED',
    image: '/it-audience.jpg',
    description:
      'Ideal for sales managers whose reps are burning dial time on disconnected switchboards or sending emails to executives who changed jobs 8 months ago.',
    points: [
      'Detection and replacement of departed personnel with current active buyers',
      'Direct phone line and mobile phone appending for key decision makers',
      'Accurate updated corporate titles and live LinkedIn profile verification',
    ],
    visualType: 'sales',
  },
  {
    id: 'migration',
    num: '03',
    label: 'CRM Migration Teams',
    tagline: 'NEVER MIGRATE DIRTY DATA',
    color: '#72D669',
    image: '/services-audience.jpg',
    description:
      'Engineered for companies migrating between Salesforce, HubSpot, Marketo, or Dynamics 365 that want to scrub and standardize data before platform cutover.',
    points: [
      'Pre-migration schema mapping and data standardization audit',
      'Syntax normalization for phone numbers, addresses, and industry taxonomies',
      'Clean, ready-to-import data packages ensuring flawless Day 1 adoption',
    ],
    visualType: 'migration',
  },
  {
    id: 'compliance',
    num: '04',
    label: 'Data Compliance & IT Officers',
    tagline: 'STRICT GDPR & CAN-SPAM COMPLIANCE',
    color: '#FF6D00',
    image: '/enterprise-audience.jpg',
    description:
      'Designed for IT and legal teams responsible for ensuring customer databases comply with global data privacy regulations and global opt-out registries.',
    points: [
      'Identification and suppression of global unsubscribe and DNC records',
      'Explicit consent timestamp verification and data source documentation',
      'Continuous compliance monitoring preventing domain spam penalties',
    ],
...
const AudienceVisualBackground = ({ type, color }) => {
  ...
  return (
    ...
    >
      ...
      <text x="150" y="62" textAnchor="middle" fill={color} fontSize="11" fontFamily="monospace" fontWeight="bold">SECURITY</text>
      ...
      <text x="70" y="170" textAnchor="middle" fill={color} fontSize="9" fontFamily="monospace">COMPLIANCE</text>
      <rect x="115" y="150" width="70" height="30" rx="5" stroke={color} strokeWidth="1.2" />
      <text x="150" y="170" textAnchor="middle" fill={color} fontSize="9" fontFamily="monospace">PRIVACY</text>
      <rect x="195" y="150" width="70" height="30" rx="5" stroke={color} strokeWidth="1.2" />
      <text x="230" y="170" textAnchor="middle" fill={color} fontSize="9" fontFamily="monospace">AUDIT</text>
    </svg>
  )
}
...
const WhoIsItFor = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ScrollTrigger.create({
        id: 'who-is-it-for-cleansing-scroll',
  ...
  const handleSelect = (idx) => {
    ...
    if (isDesktop && !prefersReducedMotion) {
      const st = ScrollTrigger.getById('who-is-it-for-cleansing-scroll')
      if (st) {
  ...
  return (
    <section
      ref={sectionRef}
      id="who-benefits-from-database-cleansing"
      className="relative py-6 sm:py-8 lg:py-8 overflow-hidden bg-background"
      aria-label="Is Database Cleansing Right for Your Business?"
    >
      {/* Background accents */}
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center mb-3.5 lg:mb-4">
          ...
          >
            Essential for revenue operations, sales leadership, and compliance teams looking to protect sender reputation, eliminate duplicate bloat, and accelerate sales pipeline.
          </motion.p>
        </div>

        {/* ── Desktop & Tablet: Large Rounded Showcase Container ── */}
        <motion.div
          {...fadeUp(0.18)}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6 items-center">
                      ...
                      <div className="lg:col-span-5">
                        ...
                        >
                          <img
                            src={active.image}
                            alt={`${active.label} Database Hygiene Interface`}
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              >
                <img
                  src={active.image}
                  alt={`${active.label} Cleansing Preview`}
