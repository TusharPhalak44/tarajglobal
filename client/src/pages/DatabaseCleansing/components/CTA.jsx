...
const TRUST_PILLARS = [
  {
    id: 'bounce',
    label: 'Sub-1% Hard Bounce Guarantee',
    badge: 'ZERO BOUNCE',
    icon: Shield,
    color: '#72D669',
  },
  {
    id: 'dedup',
    label: 'Zero Duplicate CRM Bloat',
    badge: 'DEDUPLICATED',
    icon: Radar,
    color: '#00A6FF',
  },
  {
    id: 'enrich',
    label: 'Direct Dial & Mobile Appends',
    badge: 'VERIFIED DIALS',
    icon: Flame,
    color: '#FF6D00',
  },
]
...
const CTA = () => {
  ...
  const handleStartAudit = () => navigate('/contact')
  ...
  return (
    <section
      ...
      aria-label="Ready to Restore Total CRM Database Accuracy"
    >
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6 text-center">
        <motion.div style={prefersReducedMotion ? {} : { y }}>
          ...
          >
            Eliminate stale contact records, hard bounces, and duplicate CRM bloat. Request your free diagnostic audit and restore sub-1% bounce rate hygiene today.
          </motion.p>
          ...
          >
            ...
            >
              ...
              {/* Main Label */}
              <span className="text-xs sm:text-[13px] font-bold text-slate-800 dark:text-slate-100 transition-colors">
                {currPillar.label}
              </span>

              {/* Rotating Icon */}
              <div
                className="w-5 h-5 rounded-full flex items-center justify-center shadow-xs transition-transform duration-300 group-hover:rotate-12"
                style={{
