...
const OUTCOME_INDICATORS = [
  {
    num: '01',
    label: 'AUDIT & DEDUP',
    desc: 'Eliminate duplicates, bad syntax & CRM decay',
    color: 'var(--primary)',
  ...
  },
  {
    num: '02',
    label: 'SMTP VERIFY',
    desc: 'Purge dead inboxes, honeypots & spam traps',
    color: 'var(--cta)',
  ...
  {
    num: '03',
    label: 'ENRICH & RESTORE',
    desc: 'Append direct dials & restore 99%+ CRM health',
    color: 'var(--success)',
...
const WhatIsService = () => {
  ...
  // Sequential storytelling: AUDIT → VERIFY → ENRICH (cycles every 2.8s when in view, paused on hover)
  useEffect(() => {
  ...
  return (
    <section
      ...
      aria-label="What Is Database Cleansing"
    >
      {/* Background accents */}
      ...
      <div className="relative max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-8 lg:gap-10 items-center">
          ...
          <div className="relative">
            ...
            >
              <div className="relative aspect-[16/10] w-full overflow-hidden bg-surface">
                <img
                  src="/database cleansing.png"
                  alt="Database Cleansing: Better data, higher accuracy, more qualified leads"
          ...
          <div className="space-y-6">
            {/* Independent staggered paragraph reveals */}
            <motion.p
            ...
            >
              Database cleansing is the structured process of detecting, purging, and updating corrupt, duplicate, inaccurate, and outdated records from your CRM or marketing automation platform. It combines algorithmic syntax normalization, fuzzy-match deduplication, and live SMTP inbox testing to restore maximum data hygiene.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-sm sm:text-base text-text-secondary leading-relaxed"
            >
              Because B2B contact data naturally decays at 25% to 30% each year due to corporate job changes, mergers, and domain migrations, dirty data directly wastes sales dial time and destroys sender domain reputation. Taraj Global transforms decaying contact lists into pristine, verified, and enriched pipeline assets.
            </motion.p>
