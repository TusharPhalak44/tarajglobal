...
const PILLARS = [
  {
    ...
    desc: 'Real-time SMTP handshake verification and spam-trap suppression protect your corporate domain reputation.',
    icon: ShieldCheck,
    bgImage: '/light 3.png',
  ...
  {
    num: '04',
    title: 'Direct Dial & Mobile Appends',
    desc: 'Enrich incomplete records with verified direct dials, corporate cell numbers, and active personal LinkedIn profile URLs.',
    icon: Phone,
    bgImage: '/light 3.png',
    darkBgImage: '/dark 3.png',
  },
...
const WhyChoose = () => {
  ...
  return (
    <section
      id="why-choose-taraj-global-database-cleansing"
      ...
      aria-label="Why Choose Taraj Global for Database Cleansing"
    >
      ...
      <div className="relative max-w-[1560px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-6">
          ...
          >
            Rigorous database hygiene protocols engineered to eliminate bounce risks, duplicate bloat, and sales rep friction.
          </motion.p>
        </div>
