...
const ENGINE_LAYERS = [
  {
    num: '01',
    layer: 'Layer 01',
    title: 'Complete Database Audit & Health Scorecard',
    shortTitle: 'Health Audit',
    tag: 'Diagnostic Analysis',
    module: 'DemandFlow Bridge™ Admin',
    screen: 'Database Decay & Hygiene Diagnostic Center',
    metric: '49 Live Campaigns • 84 Daily Target',
    desc: 'Comprehensive health audit diagnosing data decay percentages, duplicate clusters, invalid syntax counts, and hard bounce risks.',
    icon: FileText,
    image: '/demandflow-admin.png',
    points: [
      'Total contact record breakdown by validity and decay risk',
      'Detailed duplicate cluster analysis across leads and accounts',
      'Executive presentation detailing hygiene recommendations',
    ],
  },
  {
    num: '02',
    layer: 'Layer 02',
    title: 'DBMS Touch, Assignment & Control Center',
    shortTitle: 'DBMS Operations',
    tag: 'Throughput Control',
    module: 'DemandFlow Bridge™ DBMS',
    screen: 'Assignment, Touch & Throughput Control Center',
    metric: '1,055 Records • CDQA Approved',
    desc: 'Live tracking of record ownership, touched loads, and active Research / CDQA queue movements across the cleansing workflow.',
    icon: Database,
    image: '/demandflow-dbms.png',
    points: [
      'Real-time visibility into active Research and CDQA queue volumes',
      'Monitoring of touched vs untouched backlog records across all lanes',
      '1,055+ records throughput management with granular auditor ownership',
    ],
  },
  {
    num: '03',
    layer: 'Layer 03',
    title: 'Real-Time SMTP Live Ping Verification',
    shortTitle: 'SMTP Validation',
    tag: 'Deliverability Defense',
    module: 'DemandFlow Bridge™ Sequences',
    screen: 'Deliverability & Mailbox Hygiene Console',
    metric: '99.4% Deliverability • 4-Step Architecture',
    desc: 'Every email address is validated through direct real-time SMTP handshakes with destination mail servers, catching closed inboxes.',
    icon: FileCheck,
    image: '/demandflow-sequences.png',
    points: [
      'Live SMTP mailbox verification with zero outbound email sent',
      'Detection and suppression of known honeypots and spam traps',
      'Sub-1% hard bounce rate deliverability guarantee',
    ],
  },
  {
    num: '04',
    layer: 'Layer 04',
    title: 'Advanced Fuzzy Logic Deduplication',
    shortTitle: 'Deduplication',
    tag: 'Fuzzy Matching',
    module: 'DemandFlow Bridge™ Matrix',
    screen: 'Dynamic Variable & Deduplication Matrix',
    metric: '95.5% Match Rate • A/B Conversion Lift',
    desc: 'Identifies duplicate records across variations of email, company name, and phone number, merging them while preserving deal history.',
    icon: Trash2,
    image: '/demandflow-personalization.png',
    points: [
      'Fuzzy matching logic handling typos, nicknames, and domain variations',
      'Preservation of all custom fields, activity logs, and deal stages',
      'Resolution of competing sales ownership and territory conflicts',
    ],
  },
  {
    num: '05',
    layer: 'Layer 05',
    title: 'Batch Cleansing Pacing & Operations',
    shortTitle: 'Batch Pacing',
    tag: 'Live Orchestration',
    module: 'DemandFlow Bridge™ Campaigns',
    screen: 'Campaign Operations & Pacing Board',
    metric: 'Live Allocation • 100% Pacing Tracking',
    desc: 'Throttled batch processing ensuring deep multi-level verification without bottlenecking your live sales workflows.',
    icon: Layers,
    image: '/demandflow-campaigns.png',
    points: [
      'Continuous batch status pacing from intake to CDQA sign-off',
      'Zero CRM downtime during scrubbing and synchronization',
      'Audit log trail capturing every merged and purged record',
    ],
  },
  {
    num: '06',
    layer: 'Layer 06',
    title: 'Employment & Title Verification Telemetry',
    shortTitle: 'Title Verification',
    tag: 'Executive Mobility',
    module: 'DemandFlow Bridge™ Telemetry',
    screen: 'Response Telemetry & Mobility Tracking',
    metric: '24.8K Opens • 842 Positive Replies',
    desc: 'Verify whether each contact is still actively employed at the recorded company, updating changed titles and incoming replacements.',
    icon: UserCheck,
    image: '/demandflow-tracking.png',
    points: [
      'Flagging and archiving of departed employees in your CRM',
      'Discovery of replacement decision-makers currently holding the role',
      'Updating corporate job titles, departments, and seniority tiers',
    ],
  },
  {
    num: '07',
    layer: 'Layer 07',
    title: 'Turnkey CRM Re-Sync & CDQA Certification',
    shortTitle: 'CRM Re-Sync',
    tag: 'Pipeline Logistics',
    module: 'DemandFlow Bridge™ QA',
    screen: 'Lead Qualification & QA Control Center',
    metric: '765 Qualified • 100% Client Ready',
    desc: 'We write cleansed, deduplicated records directly back into your CRM with full GDPR/CCPA compliance and 100% accuracy guarantees.',
    icon: BadgeCheck,
    image: '/demandflow-qualification.png',
    points: [
      'Direct bi-directional API sync with zero manual CSV manipulation',
      'Custom schema property mapping preventing data truncation',
      'Full GDPR and CCPA compliant permanent data destruction of staging files',
    ],
  },
]
...
const WhatTarajDelivers = () => {
  ...
  return (
    <section
      id="what-taraj-delivers-cleansing"
      ...
      aria-label="What Taraj Global Delivers for Database Cleansing"
    >
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-6">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-tight leading-tight uppercase">
            ...
            <span className="text-[#00A6FF] drop-shadow-[0_0_25px_rgba(0,166,255,0.4)]">
              Deliver in Data Cleansing?
            </span>
          </h2>

          <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 leading-relaxed max-w-2xl mx-auto mt-2 font-normal">
            Taraj Global delivers complete database hygiene overhauls restoring sender reputation, eliminating duplicate waste, and boosting SDR connections.
          </p>
        </div>
