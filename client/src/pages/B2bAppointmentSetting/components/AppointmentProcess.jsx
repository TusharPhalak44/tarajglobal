...
import WorkflowCanvas from './AppointmentProcessWorkflow/WorkflowCanvas'
import WorkflowMobileView from './AppointmentProcessWorkflow/WorkflowMobileView'
import { WORKFLOW_STEPS } from './AppointmentProcessWorkflow/workflowData'
...
const AppointmentProcess = () => {
  ...
  return (
    <section
      ...
      aria-label="How Our B2B Appointment Setting Process Works"
    >
      ...
      <div className="relative max-w-[1380px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-5">
          ...
          {/* Main Title: HOW OUR APPOINTMENT SETTING PROCESS WORKS */}
          <motion.div
          ...
          >
            Taraj Global delivers qualified sales appointments by combining targeted B2B data, prospect research, personalized outreach, buyer intent signals, and structured qualification.
          </motion.p>
        </div>
