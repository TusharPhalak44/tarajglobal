...
const TRUST_PILLARS = [
  {
    id: 'decision-makers',
    label: '100% Vetted Decision-Makers',
  ...
  {
    id: 'attendance',
    label: '85%+ Guaranteed Meeting Show Rate',
    badge: 'ATTENDANCE SLA',
    icon: Shield,
    color: '#72D669',
  },
  {
    id: 'intent',
    label: 'Active In-Quarter Buying Intent',
    badge: 'IN-QUARTER',
    icon: Flame,
    color: '#FF6D00',
  },
...
const CTA = () => {
  ...
  return (
    <section
      ...
      aria-label="Ready to Create More Qualified Sales Meetings"
    >
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6 text-center">
        <motion.div style={prefersReducedMotion ? {} : { y }}>
          ...
          >
            Connect your sales team with relevant decision-makers and build a stronger pipeline with targeted B2B appointment setting.
          </motion.p>
