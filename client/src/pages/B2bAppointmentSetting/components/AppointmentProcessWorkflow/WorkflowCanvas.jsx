      ...
      >
        ...
        >
          <WorkflowCard
            ...
            onClick={() => onSelectStep && onSelectStep(0)}
            isReducedMotion={isReducedMotion}
            className="h-full"
          />
        </div>

        {/* ── CARD 02: Research (Top Row, Right) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '52.85%',
        ...
        {/* ── CARD 03: Verified Data (Middle Row, Col 1) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '1.42%',
        ...
        {/* ── CARD 04: Qualify (Middle Row, Col 2) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '18.57%',
        ...
        {/* ── CARD 05: Engage (Middle Row, Col 3) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '35.71%',
        ...
        {/* ── CARD 06: Connect (Middle Row, Col 4) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '52.85%',
        ...
        {/* ── CARD 07: Confirm & Prep (Middle Row, Col 5) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '70.00%',
        ...
        {/* ── FINAL TARGET: DELIVER QUALIFIED MEETINGS (Middle Row, Col 6) ── */}
        <div
        ...
        {/* ── CARD 08: Reschedule Protection (Bottom Row, Left of 09) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '37.85%',
        ...
        {/* ── CARD 09: Handoff & Insights (Bottom Row, Below 07) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '70.00%',
