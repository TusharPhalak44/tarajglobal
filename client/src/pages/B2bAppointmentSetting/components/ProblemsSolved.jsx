...
// ─── 5 Problem → Engine → Solution Transformation Pairs (Appointment Setting) ──
...
const FLOW_ITEMS = [
  {
    ...
    num: '01',
    category: 'CAPACITY',
    engineLabel: 'SDR Capacity Pods',
    engineAction: 'Outreach Delegation',
    problem: {
      title: 'Limited Prospecting Capacity',
      sub: 'Overwhelmed Internal Sales Teams',
      icon: FilterX,
    },
    solution: {
      title: 'Reduced Internal Pressure',
      sub: 'More Bandwidth for Closing',
      icon: Focus,
    },
    color: '#00A6FF',
  ...
  },
  {
    ...
    num: '02',
    category: 'ACCESS',
    engineLabel: 'Executive Outbound',
    engineAction: 'Decision-Maker Access',
    problem: {
      title: 'Difficulty Reaching Decision-Makers',
      sub: 'Gatekeepers & Stalled Outbox',
      icon: MailX,
    },
    solution: {
      title: 'Connect with Stakeholders',
      sub: 'Verified C-Suite & VP Economic Buyers',
  ...
  },
  {
    ...
    engineLabel: 'Pacing & Quota Control',
    engineAction: 'Predictable Dispatch',
    problem: {
      title: 'Inconsistent Sales Conversations',
      sub: 'Unpredictable Pipeline Lulls',
      icon: ShieldAlert,
    },
    solution: {
      title: 'Consistent Meeting Flow',
      sub: 'Steady In-Quarter Discovery Calendar',
      icon: CheckCircle2,
    },
    color: '#10B981',
  ...
  },
  {
    ...
    num: '04',
    category: 'EFFICIENCY',
    engineLabel: 'Multi-Touch Automation',
    engineAction: 'Omnichannel Sprints',
    problem: {
      title: 'Time-Consuming Outreach',
      sub: 'Manual Sourcing, Dials & Follow-ups',
      icon: Workflow,
    },
    solution: {
      title: 'Streamlined Engagement',
      sub: 'Coordinated Phone, Email & Social Sprints',
      icon: Send,
    },
    color: '#F59E0B',
  ...
  },
  {
    ...
    num: '05',
    category: 'QUALITY',
    engineLabel: 'CDQA Gatekeeping',
    engineAction: 'Strict Qualification Audit',
    problem: {
      title: 'Low-Quality Meetings',
      sub: 'Unqualified Pitch Calls Draining Morale',
      icon: EyeOff,
    },
    solution: {
      title: 'Agreed Qualification Criteria',
      sub: 'Prospects Aligned with Buying Criteria',
      icon: BarChart3,
    },
    color: '#EC4899',
...
const ProblemsSolved = () => {
  ...
  return (
    <section
      ...
      aria-label="What Problems Does Appointment Setting Solve"
    >
      ...
      <div className="relative max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-4 sm:mb-5">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-tight leading-tight uppercase">
            <span>What Business Problem Does </span>
            <span className="bg-gradient-to-r from-primary via-[#00c8ff] to-cta bg-clip-text text-transparent">
              Appointment Setting Solve?
            </span>
          </h2>

          <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 leading-relaxed max-w-3xl mx-auto mt-1.5 font-normal">
            Taraj Global connects you with the right decision-makers through targeted prospecting and appointment setting—turning sales challenges into qualified conversations.
          </p>
        ...
        >
          ...
          >
            ...
            {/* ── Active Traveling Particle: Left to Center (Glowing Comet) ── */}
            ...
            {/* ── Active Traveling Particle: Center to Right (Glowing Comet) ── */}
          ...
          <div className="relative z-10 grid grid-cols-12 gap-2.5 lg:gap-3.5 items-center">
            ...
            {/* ── CENTER: Compact Glowing Circular Engine (4 cols) ── */}
            <div className="col-span-4 flex flex-col items-center justify-center">
              ...
              >
                ...
                >
                  ...
                  {/* Dynamic Problem -> Solution Illustration */}
