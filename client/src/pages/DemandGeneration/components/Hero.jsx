...
// ─── Command Center Flow Visual for Demand Generation ────────────────────────
...
const FLOW_STAGES = [
  ...
  { id: 'multichannel', label: 'Multi-Channel Campaign', sub: 'Inbound & Outbound Touch', color: '#00A6FF', icon: 'channel'   },
  { id: 'engage',    label: 'Buyer Engagement',      sub: 'Content & Interaction Signals', color: '#FFA600', icon: 'engage'    },
  { id: 'intent',    label: 'Intent Qualification',  sub: 'Engagement & Fit Scored',     color: '#72D669', icon: 'reply'     },
...
const STATUS_PILLS = [
  ...
  { label: 'Intent Scored', dot: '#72D669' },
...
function ChannelIcon({ color }) {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <rect x="2" y="3" width="14" height="10" rx="2" stroke={color} strokeWidth="1.5" />
      <path d="M5 16h8M9 13v3" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
      <path d="M6 7l3 2 3-2" stroke={color} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
...
function StageIcon({ type, color }) {
  ...
  if (type === 'channel')   return <ChannelIcon color={color} />
...
function CommandCenter({ prefersReducedMotion }) {
  ...
  return (
    <div
      ...
      role="img"
      aria-label="Animated B2B demand generation campaign workflow from targeted prospects to qualified sales pipeline"
    >
      {/* Grid background */}
      <div
      ...
      <div className="border-t border-white/[0.05] px-5 py-3 grid grid-cols-3 gap-3">
        {[
          ...
          { label: 'Buyer Engagement', value: 'Surging', color: '#FFA600' },
          { label: 'Pipeline Sync', value: 'In Progress', color: '#00A6FF' },
        ].map((m) => (
...
const Hero = () => {
  ...
  return (
    <section
      ...
      aria-label="B2B Demand Generation Hero"
    >
      {/* Background */}
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-4 sm:pt-6 sm:pb-6 lg:pt-6 lg:pb-6">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="flex flex-col justify-center order-1 lg:order-1">
            ...
            >
              <span className="block pb-1 sm:pb-1.5">Build Demand.</span>
              <span
              ...
              >
                Generate Qualified B2B Opportunities.
              </span>
            </motion.h1>
            ...
            >
              Taraj Global helps B2B technology and SaaS companies build targeted demand, reach decision-makers, engage high-value audiences, and generate qualified opportunities through data-driven demand generation strategies.
            </motion.p>
