...
import WorkflowCanvas from './DemandProcessWorkflow/WorkflowCanvas'
import WorkflowMobileView from './DemandProcessWorkflow/WorkflowMobileView'
    ...
    >
      ...
      <div className="relative max-w-[1380px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-5">
          ...
          {/* Main Title: OUR PROVEN B2B DEMAND GENERATION IMPLEMENTATION PROCESS */}
          <motion.div
          ...
          <motion.p
            ...
            className="text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed max-w-2xl mx-auto mt-3 font-normal"
          >
            A multi-stage, end-to-end demand generation engine designed to create, capture, and convert in-market B2B decision-makers into sales-qualified pipeline.
          </motion.p>
        </div>

        {/* ── DESKTOP WORKFLOW CANVAS (Screen >= 1024px) ── */}
