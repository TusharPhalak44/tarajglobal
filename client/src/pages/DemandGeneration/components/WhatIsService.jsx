...
const OUTCOME_INDICATORS = [
  ...
  },
  {
    num: '02',
    label: 'ENGAGE',
    desc: 'Create relevant buyer interactions',
    color: 'var(--cta)',
...
const WhatIsService = () => {
  ...
  return (
    <section
      ...
      aria-label="What Is B2B Demand Generation"
    >
      {/* Background accents */}
      ...
      <div className="relative max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-8 lg:gap-10 items-center">
            ...
            >
              <div className="relative aspect-[16/10] w-full overflow-hidden bg-surface">
                <img
                  ...
                  alt="B2B Demand Generation Journey: Target, Engage, Convert"
          ...
          <div className="space-y-6">
            ...
            >
              B2B Demand Generation is a strategic approach to creating awareness, engaging relevant buyers, and generating demand among target accounts and decision-makers throughout the buying journey.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-sm sm:text-base text-text-secondary leading-relaxed"
            >
              Unlike disconnected single-point tactics, effective B2B demand generation aligns audience intelligence, content syndication, multi-channel outreach, and automated lead nurturing into a unified conversion engine that delivers qualified, sales-ready pipeline.
            </motion.p>
