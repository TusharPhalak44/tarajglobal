...
const AUDIENCES = [
  {
    ...
    description:
      'Scale product awareness, engage engineering and commercial buyers, and accelerate self-serve trials and enterprise demo requests through targeted full-funnel demand generation.',
    points: [
      'Account-level targeting filtered by verified tech stack, ARR band, and software category',
      'Multi-touch demand generation across content syndication, LinkedIn, and email',
      'Automated nurture workflows converting engaged prospects into active sales discovery calls',
    ],
    visualType: 'saas',
  },
  {
    ...
    description:
      'Educate technical buyers, enterprise architects, and engineering stakeholders with deep-dive technical assets, whitepapers, and interactive product briefings.',
    points: [
      'Engage technical evaluators researching complex enterprise platforms and tools',
      'Syndicate architectural blueprints, benchmarks, and product comparison reports',
      'Capture multi-channel intent signals and route scored opportunities to sales engineers',
    ],
    visualType: 'it',
  },
  {
    ...
    description:
      'Position managed services, IT modernization, and cybersecurity solutions directly in front of CIOs, IT directors, and enterprise procurement leaders.',
    points: [
      'Targeting senior IT decision-makers across mid-market and enterprise accounts',
      'Thought leadership syndication establishing trusted authority and RFP consideration',
      'Direct account-level dossiers with verified direct dials and verified corporate emails',
    ],
    visualType: 'services',
  },
  {
    ...
    tagline: 'BRAND AUTHORITY & FULL-FUNNEL ENGAGEMENT',
    color: '#FF6D00',
    image: '/services-audience.jpg',
    description:
      'Execute high-impact integrated demand campaigns that elevate category positioning, expand target account reach, and generate predictable, measurable buyer demand.',
    points: [
      'Full-funnel campaign execution aligning brand awareness with lead capture',
      'Multi-channel promotional distribution across syndication, email, and social',
      'Closed-loop marketing attribution and actionable buyer engagement analytics',
    ],
  ...
  },
  {
    ...
    tagline: 'PIPELINE VELOCITY & REVENUE GROWTH',
    color: '#EC4899',
    image: '/saas-audience.jpg',
    description:
      'Scale qualified lead volume, lower customer acquisition costs (CAC), and turn top-of-funnel engagement into sales-ready opportunities with verified buyer intent.',
    points: [
      'Guaranteed ICP-verified lead delivery with transparent, predictable CPL models',
      'Behavioral lead scoring assessing content consumption and buyer intent signals',
      'Seamless CRM integration with instant lead syncing to HubSpot, Salesforce, and Marketo',
    ],
    visualType: 'saas',
  },
  {
    ...
    image: '/enterprise-audience.jpg',
    description:
      'Reach hard-to-access C-level executives, VPs, and senior directors who hold strategic budget authority with tailored account-based messaging and exclusive briefings.',
    points: [
      'Strict title-level qualification and seniority verification protocols',
      'Personalized executive touchpoints designed for multi-stakeholder buying committees',
      'High-touch nurture cadences designed for complex, high-ACV enterprise deals',
    ],
    visualType: 'enterprise',
  },
]
...
const AudienceVisualBackground = ({ type, color }) => {
  ...
  return (
    ...
    >
      ...
      <text x="230" y="170" textAnchor="middle" fill={color} fontSize="9" fontFamily="monospace">MARKETING</text>
...
const WhoIsItFor = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ScrollTrigger.create({
        id: 'who-is-it-for-demand-scroll',
  ...
  const handleSelect = (idx) => {
    ...
    if (isDesktop && !prefersReducedMotion) {
      const st = ScrollTrigger.getById('who-is-it-for-demand-scroll')
      if (st) {
  ...
  return (
    <section
      ref={sectionRef}
      id="who-benefits-from-demand-generation"
      className="relative py-6 sm:py-8 lg:py-8 overflow-hidden bg-background"
      aria-label="Is B2B Demand Generation Right for You?"
    >
      {/* Background accents */}
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center mb-3.5 lg:mb-4">
          ...
          <motion.h2
            {...fadeUp(0.08)}
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-tight leading-tight text-text-primary mb-2 whitespace-nowrap"
          >
            Is B2B Demand Generation{' '}
          ...
          >
            B2B demand generation serves organizations looking to create awareness, engage target accounts, and generate sustainable, sales-ready pipeline across every stage of the buyer journey.
          </motion.p>
        </div>
