...
import WorkflowCanvas from './BantProcessWorkflow/WorkflowCanvas'
import WorkflowMobileView from './BantProcessWorkflow/WorkflowMobileView'
import { WORKFLOW_STEPS } from './BantProcessWorkflow/workflowData'
    ...
    >
      ...
      <div className="relative max-w-[1380px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-5">
          ...
          {/* Main Title: BANT LEAD GENERATION WORKFLOW */}
          <motion.div
          ...
          >
            A multi-stage qualification pipeline converting unvetted target prospects into sales-ready enterprise opportunities.
          </motion.p>
        </div>
