...
const OUTCOME_INDICATORS = [
  {
    num: '01',
    label: 'TARGET',
    desc: 'Reach the right decision makers',
    color: 'var(--primary)',
  ...
  },
  {
    num: '02',
    label: 'ENGAGE',
    desc: 'Create relevant conversations',
    color: 'var(--cta)',
  ...
  },
  {
    num: '03',
    label: 'CONVERT',
    desc: 'Generate qualified opportunities',
    color: 'var(--success)',
...
const WhatIsService = () => {
  ...
  return (
    <section
      id="what-is-b2b-email-marketing"
      ...
      aria-label="What Is B2B Email Marketing"
    >
      {/* Background accents */}
      ...
      <div className="relative max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto text-center mb-8 sm:mb-10 lg:mb-12">
          ...
          {/* 2. HEADING ANIMATION — line by line reveal */}
        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-8 lg:gap-10 items-center">
          ...
          <div className="relative">
            ...
            >
              <div className="relative aspect-[16/10] w-full overflow-hidden bg-surface">
                <img
                  src="/b2b-email-marketing-journey.jpg"
                  alt="B2B Email Marketing Journey: Target, Engage, Convert"
          ...
          <div className="space-y-6">
            {/* 4. PARAGRAPH REVEAL — independent staggered reveals */}
            <motion.p
            ...
            >
              B2B email marketing is a targeted outreach strategy that connects businesses with relevant decision makers through personalized email campaigns. It combines audience targeting, verified business data, relevant messaging, campaign execution, and engagement tracking to create meaningful sales conversations.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-sm sm:text-base text-text-secondary leading-relaxed"
            >
              Unlike mass email blasting, effective B2B email marketing is built around your ideal customer profile, reaching specific roles, industries, and organizations with messaging that reflects their actual business context. The result is outreach that generates qualified responses rather than low-intent noise.
            </motion.p>

            {/* 5. PROCESS CARDS — MAIN INTERACTION */}
              ...
              >
                {OUTCOME_INDICATORS.map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      {/* 6. CARD PROGRESS ANIMATION (Draws left to right on entrance) */}
                      <motion.div
                      ...
                      {/* Header with Number, connecting line, and 9. MICRO-INTERACTION */}
                      ...
                      {/* Label */}
                      <div
                        className="text-xs font-mono font-bold tracking-[0.2em] uppercase transition-colors duration-200"
                        style={{ color: item.color }}
                      >
                        {item.label}
                      </div>
                      ...
                      {/* Description */}
                      <div className="text-xs sm:text-[13px] text-text-secondary leading-normal">
                        {item.desc}
                      </div>
                    </motion.div>
                  )
