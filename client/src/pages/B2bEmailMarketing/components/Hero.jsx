...
const FLOW_STAGES = [
  ...
  { id: 'email',     label: 'Personalized Email',    sub: 'Multi-step Sequence',         color: '#00A6FF', icon: 'mail'      },
  { id: 'engage',    label: 'Engagement',            sub: 'Opened · Clicked',            color: '#FFA600', icon: 'engage'    },
  { id: 'response',  label: 'Response',              sub: 'Direct Reply',                color: '#72D669', icon: 'reply'     },
  { id: 'qualified', label: 'Qualified Opportunity', sub: 'Sales Conversation Ready',   color: '#FF6D00', icon: 'qualified' },
]

const STATUS_PILLS = [
  { label: 'Delivered', dot: '#00A6FF' },
  { label: 'Opened',    dot: '#FFA600' },
  { label: 'Engaged',   dot: '#38BDF8' },
  { label: 'Replied',   dot: '#72D669' },
...
function CommandCenter({ prefersReducedMotion }) {
  ...
  return (
    <div
      ...
      role="img"
      aria-label="Animated B2B email marketing campaign workflow from targeted prospects to qualified sales opportunities"
    >
      {/* Grid background */}
      <div
      ...
      <div className="border-t border-white/[0.05] px-5 py-3 grid grid-cols-3 gap-3">
        {[
          ...
          { label: 'Avg. Response', value: 'Engaged', color: '#FFA600' },
...
const Hero = () => {
  ...
  const handleSeeHowItWorks = () => {
    const el = document.getElementById('email-process')
  ...
  return (
    <section
      ...
      aria-label="B2B Email Marketing Hero"
    >
      {/* Background */}
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-4 sm:pt-6 sm:pb-6 lg:pt-6 lg:pb-6">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="flex flex-col justify-center order-1 lg:order-1">
            ...
            >
              <span className="block pb-1 sm:pb-1.5">Turn Targeted Emails</span>
              <span
              ...
              >
                Into Qualified B2B Conversations
              </span>
            </motion.h1>
            ...
            >
              Reach the right decision makers with targeted, personalized B2B email campaigns designed to create meaningful engagement, generate qualified responses, and support predictable sales pipeline growth.
            </motion.p>
