...
const TRUST_PILLARS = [
  ...
  {
    id: 'qualification',
    label: 'Sales Focused Qualification',
    badge: 'HIGH INTENT',
    icon: Flame,
    color: '#FF6D00',
  },
...
const CTA = () => {
  ...
  return (
    <section
      ...
      aria-label="Ready to Turn B2B Email Into Sales Conversations"
    >
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6 text-center">
        <motion.div style={prefersReducedMotion ? {} : { y }}>
          ...
          >
            Build targeted email campaigns around your ideal customers, decision makers, messaging, and revenue goals.
          </motion.p>
