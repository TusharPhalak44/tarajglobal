...
import WorkflowCanvas from './EmailProcessWorkflow/WorkflowCanvas'
import WorkflowMobileView from './EmailProcessWorkflow/WorkflowMobileView'
import { WORKFLOW_STEPS } from './EmailProcessWorkflow/workflowData'
...
const EmailProcess = () => {
  ...
  return (
    <section
      ...
      aria-label="How Our B2B Email Marketing Process Works"
    >
      ...
      <div className="relative max-w-[1380px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-5">
          ...
          {/* Main Title: B2B EMAIL MARKETING WORKFLOW */}
          <motion.div
          ...
          >
            A multi-stage targeted outreach pipeline converting verified B2B decision-makers into sales-qualified meetings.
          </motion.p>
        </div>
