...
const TRUST_PILLARS = [
  {
    id: 'targeted',
    label: 'ICP Targeted Syndication',
    badge: 'TARGETED',
    icon: Radar,
    color: '#00A6FF',
  },
...
const CTA = () => {
  ...
  return (
    <section
      ...
      aria-label="Ready to Turn Content Reach Into Sales Opportunities"
    >
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6 text-center">
        <motion.div style={prefersReducedMotion ? {} : { y }}>
          ...
          >
            Ready to Turn Content Reach Into{' '}
            <span
          ...
          >
            Launch targeted content syndication campaigns that put your authoritative assets in front of active decision-makers with guaranteed CPL delivery.
          </motion.p>
