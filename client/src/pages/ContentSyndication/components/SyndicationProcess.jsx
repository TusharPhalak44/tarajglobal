...
import WorkflowCanvas from './SyndicationProcessWorkflow/WorkflowCanvas'
import WorkflowMobileView from './SyndicationProcessWorkflow/WorkflowMobileView'
import { WORKFLOW_STEPS } from './SyndicationProcessWorkflow/workflowData'
...
const SyndicationProcess = () => {
  ...
  return (
    <section
      ...
      aria-label="How Our B2B Content Syndication Process Works"
    >
      ...
      <div className="relative max-w-[1380px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-5">
          ...
          {/* Main Title: B2B CONTENT SYNDICATION WORKFLOW */}
          <motion.div
          ...
          >
            A multi-stage syndication pipeline distributing high-value assets across premier networks to deliver sales-qualified leads.
          </motion.p>
        </div>
...
export default SyndicationProcess
