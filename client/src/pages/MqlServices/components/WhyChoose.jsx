...
const PILLARS = [
  {
    num: '01',
    title: 'ICP-First Curation',
    desc: 'Campaigns calibrated strictly against your Ideal Customer Profile. From firmographics to tech install stacks, we target accounts that fit your exact qualification criteria.',
    icon: Crosshair,
    bgImage: '/light 3.png',
  ...
  },
  {
    ...
    desc: 'Reach relevant budget-holders instead of relying on broad, untargeted outreach. Taraj Global connects directly with the specific stakeholder roles that drive buying decisions.',
    icon: Briefcase,
    bgImage: '/light 3.png',
    darkBgImage: '/dark 3.png',
  },
  {
    num: '03',
    title: 'Multi-Touch Intent Scoring',
    desc: 'Evaluate prospect readiness through content consumption, asset downloads, and topic surge telemetry, filtering for verified buying signals and high commercial intent.',
  ...
  },
  {
    ...
    desc: '100% human and SMTP-verified contact data. We validate active corporate inboxes and phone extensions to guarantee zero bounce rates and clean CRM delivery.',
    icon: PieChart,
    bgImage: '/light 3.png',
    darkBgImage: '/dark 3.png',
  },
  {
    ...
    desc: 'Structured lead handoffs with complete engagement history, consent timestamps, and screening notes delivered directly to your CRM to accelerate SDR pipeline conversion.',
    icon: CheckCheck,
    bgImage: '/light 3.png',
    darkBgImage: '/dark 3.png',
  },
...
const WhyChoose = () => {
  ...
  return (
    <section
      id="why-choose-taraj-global-mql"
      ...
      aria-label="Why Choose Taraj Global for MQL Services"
    >
      ...
      <div className="relative max-w-[1560px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-6">
          ...
          >
            High-intent Marketing Qualified Leads that accelerate sales velocity and convert into pipeline opportunities.
          </motion.p>
        </div>
