...
// 3 Core Trust Pillars unified into the single animated button (MQL Focused)
const TRUST_PILLARS = [
  {
    id: 'targeted',
    label: 'ICP Targeted MQL Delivery',
    badge: 'TARGETED',
    icon: Radar,
    color: '#00A6FF',
  },
  {
    id: 'data',
    label: '100% Zero-Bounce Verified Data',
    badge: 'ZERO BOUNCE',
    icon: Shield,
    color: '#72D669',
  },
  {
    id: 'intent',
    label: 'Behavioral Intent Qualification',
    badge: 'HIGH INTENT',
    icon: Flame,
    color: '#FF6D00',
  },
...
const CTA = () => {
  ...
  return (
    <section
      ...
      aria-label="Ready to Turn High-Intent Audience Into Sales-Ready Leads"
    >
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6 text-center">
        <motion.div style={prefersReducedMotion ? {} : { y }}>
          ...
          >
            Ready to Turn High-Intent Audience Into{' '}
            <span
          ...
          >
            Deploy verified, multi-channel MQL campaigns customized to your Ideal Customer Profile, decision-makers, and pipeline goals.
          </motion.p>
          ...
          >
            ...
            >
              Start Your MQL Campaign
              <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
            </button>

            <button
              id="cta-talk-to-mql-team"
          ...
          >
            ...
            >
              ...
              {/* Animated Text Cycler: ICP-Targeted → Verified Data → Sales Qualification */}
