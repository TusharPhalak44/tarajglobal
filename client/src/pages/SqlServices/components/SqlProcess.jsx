...
import WorkflowCanvas from './SqlProcessWorkflow/WorkflowCanvas'
import WorkflowMobileView from './SqlProcessWorkflow/WorkflowMobileView'
import { WORKFLOW_STEPS } from './SqlProcessWorkflow/workflowData'
...
const SqlProcess = () => {
  ...
  return (
    <section
      ...
      aria-label="How Our SQL Lead Generation Process Works"
    >
      ...
      <div className="relative max-w-[1380px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-5">
          ...
          {/* Main Title: SQL LEAD GENERATION WORKFLOW */}
          <motion.div
          ...
          >
            A multi-stage qualification pipeline converting target prospects into verified, sales-ready opportunities directly in your CRM.
          </motion.p>
        </div>
