...
export default function WorkflowCanvas({
  ...
  return (
    <div className="relative w-full max-w-[1300px] mx-auto">
      ...
      <div className="relative w-full aspect-[1400/520] min-h-[440px] lg:min-h-[480px] rounded-2xl p-3 overflow-visible bg-transparent">
        ...
        {/* CARD 01: ICP & Sales Goals (Top Row, Left) */}
        <div
        ...
        {/* CARD 02: Criteria Calibration (Top Row, Right) */}
        <div
          className="absolute z-10"
          style={{
            left: '52.85%',
        ...
        {/* CARD 03: Account Discovery (Middle Row, Col 1) */}
        <div
          className="absolute z-10"
          style={{
            left: '1.42%',
        ...
        {/* CARD 04: Prospect Research (Middle Row, Col 2) */}
        <div
          className="absolute z-10"
          style={{
            left: '18.57%',
        ...
        {/* CARD 05: Multi-Touch Outreach (Middle Row, Col 3) */}
        <div
          className="absolute z-10"
          style={{
            left: '35.71%',
        ...
        {/* CARD 06: Intent & Need Probing (Middle Row, Col 4) */}
        <div
          className="absolute z-10"
          style={{
            left: '52.85%',
        ...
        {/* CARD 07: Sales Readiness Check (Middle Row, Col 5) */}
        <div
          className="absolute z-10"
          style={{
            left: '70.00%',
        ...
        {/* FINAL TARGET: QUALIFIED SQL LEADS */}
        <div
        ...
        {/* CARD 08: CDQA Quality Audit (Bottom Row, Left of 09) */}
        <div
          className="absolute z-10"
          style={{
            left: '37.85%',
        ...
        {/* CARD 09: CRM & Calendar Sync (Bottom Row, Below 07) */}
        <div
          className="absolute z-10"
          style={{
            left: '70.00%',
