  ...
  return (
    <div className="relative w-full max-w-[1300px] mx-auto">
      ...
      >
        ...
        {/* ── CARD 01: ICP Criteria (Top Row, Left) ── */}
        <div
        ...
        {/* ── CARD 02: Target Accounts (Top Row, Right) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '52.85%',
        ...
        {/* ── CARD 03: Prospect Discovery (Middle Row, Col 1) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '1.42%',
        ...
        {/* ── CARD 04: Data Enrichment (Middle Row, Col 2) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '18.57%',
        ...
        {/* ── CARD 05: Multi-Verification (Middle Row, Col 3) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '35.71%',
        ...
        {/* ── CARD 06: List Segmentation (Middle Row, Col 4) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '52.85%',
        ...
        {/* ── CARD 07: Quality Assurance (Middle Row, Col 5) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '70.00%',
        ...
        {/* ── FINAL TARGET: VERIFIED B2B PROSPECT LISTS (Middle Row, Col 6) ── */}
        <div
        ...
        {/* ── CARD 08: CRM Integration (Bottom Row, Left of 09) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '37.85%',
        ...
        {/* ── CARD 09: Ongoing Refresh (Bottom Row, Below 07) ── */}
        <div
          className="absolute z-10"
          style={{
            left: '70.00%',
