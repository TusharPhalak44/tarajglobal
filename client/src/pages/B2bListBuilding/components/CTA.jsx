...
const TRUST_PILLARS = [
  {
    id: 'targeted',
    label: 'ICP-Targeted Prospect Lists',
    badge: 'TARGETED',
    icon: Radar,
    color: '#00A6FF',
  },
  {
    id: 'data',
    label: 'Triple-Verified Contact Data',
    badge: 'ZERO BOUNCE',
    icon: Shield,
    color: '#72D669',
  },
  {
    id: 'qualification',
    label: 'Sales-Ready Decision Makers',
    badge: 'HIGH INTENT',
    icon: Flame,
    color: '#FF6D00',
  },
...
const CTA = () => {
  ...
  return (
    <section
      ...
      aria-label="Ready to Build Your Verified B2B Prospect List"
    >
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6 text-center">
        <motion.div style={prefersReducedMotion ? {} : { y }}>
          ...
          >
            Build verified prospect lists around your ideal customers, buying committee, revenue goals, and outbound campaign needs.
          </motion.p>
