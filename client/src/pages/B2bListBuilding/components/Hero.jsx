...
// ─── Command Center Flow Visual for B2B List Building ─────────────────────────

const FLOW_STAGES = [
  { id: 'target',    label: 'Target Account',       sub: 'Ideal Customer Profile',      color: '#00A6FF', icon: 'target'    },
  { id: 'decision',  label: 'Decision Maker',        sub: 'Verified Contact',            color: '#38BDF8', icon: 'person'    },
  { id: 'validate',  label: 'Data Validation',       sub: 'Zero Bounce Cleanse',         color: '#00A6FF', icon: 'mail'      },
  { id: 'enrich',    label: 'Data Enrichment',       sub: 'Technographics & Direct Dials', color: '#FFA600', icon: 'engage'    },
  { id: 'segment',   label: 'Audience Segmentation', sub: 'Custom Cohorts & Tiers',       color: '#72D669', icon: 'reply'     },
  { id: 'deliver',   label: 'Campaign-Ready List',   sub: 'Sales Pipeline Ready',        color: '#FF6D00', icon: 'qualified' },
]

const STATUS_PILLS = [
  { label: 'Identified',  dot: '#00A6FF' },
  { label: 'Validated',   dot: '#FFA600' },
  { label: 'Enriched',    dot: '#38BDF8' },
  { label: 'Segmented',   dot: '#72D669' },
  { label: 'Delivered',   dot: '#FF6D00' },
]
...
function CommandCenter({ prefersReducedMotion }) {
  ...
  return (
    <div
      ...
      role="img"
      aria-label="Animated B2B list building workflow from targeted prospects to campaign-ready data"
    >
      {/* Grid background */}
      <div
      ...
      <div className="border-t border-white/[0.05] px-5 py-3 grid grid-cols-3 gap-3">
        {[
          { label: 'List Accuracy', value: '99.4%', color: '#72D669' },
          { label: 'Verification', value: 'Live Validated', color: '#FFA600' },
          { label: 'Pipeline Fit', value: '100% ICP', color: '#00A6FF' },
        ].map(m => (
...
const Hero = () => {
  ...
  const handleSeeHowItWorks = () => {
    const el = document.getElementById('list-building-process')
  ...
  return (
    <section
      ...
      aria-label="B2B List Building Hero"
    >
      {/* Background */}
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-4 sm:pt-6 sm:pb-6 lg:pt-6 lg:pb-6">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="flex flex-col justify-center order-1 lg:order-1">
            ...
            >
              <span className="block pb-1 sm:pb-1.5">Build Accurate B2B Lists That Connect You</span>
              <span
            ...
            >
              Taraj Global helps B2B technology and SaaS companies build targeted prospect lists with relevant company and decision-maker data to support effective sales and marketing campaigns.
            </motion.p>
