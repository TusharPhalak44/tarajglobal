...
const AUDIENCES = [
  {
    ...
    description:
      'Connect with CTOs, VPs of Engineering, and software buyers using hyper-targeted prospect lists tailored to your SaaS platform and growth cycles.',
    points: [
      'Targeting by tech stack, ARR tier, company size, and growth stage',
      'Verified decision-maker contact intelligence for product and technical leaders',
      'Campaign-ready lists supporting demos, trials, and evaluation conversations',
    ],
    visualType: 'saas',
  },
  {
    ...
    description:
      'Reach IT Directors, CIOs, and infrastructure stakeholders with validated prospect data focused on operational requirements and evaluated technology solutions.',
    points: [
      'Targeting IT Directors, CIOs, and technology infrastructure managers',
      'Enriched company firmographics including headcount, revenue, and locations',
      'Zero-bounce contact data formatted for immediate outbound sales execution',
    ],
    visualType: 'it',
  },
  {
    id: 'sales-teams',
    num: '03',
    label: 'Sales & Demand Gen Teams',
    tagline: 'OUTBOUND SDRS & REVENUE LEADERS',
    color: '#72D669',
    image: '/services-audience.jpg',
    description:
      'Fuel your outbound sales reps with accurate, fresh prospect lists to eliminate manual research time and accelerate pipeline generation.',
    points: [
      'Pre-verified prospect lists segmented by territory, industry vertical, and role',
      'Dramatically reduced prospecting time and elevated sales conversation velocity',
      'Comprehensive contact profiles with verified direct dials and corporate emails',
    ],
    visualType: 'services',
  },
  {
    id: 'enterprise',
    num: '04',
    label: 'Enterprise Solution Vendors',
    tagline: 'ENTERPRISE BUYING COMMITTEES',
    color: '#FF6D00',
    image: '/enterprise-audience.jpg',
    description:
      'Engage complex enterprise buying committees and procurement heads with multi-threaded account intelligence built for enterprise sales cycles.',
    points: [
      'Account-level mapping aligned to your enterprise ideal customer profile',
      'Multi-stakeholder contact identification across global buying departments',
      'Multi-tiered prospect data supporting strategic account-based marketing',
    ],
  ...
  if (type === 'services') {
    return (
      ...
      >
        ...
        <line x1="126" y1="100" x2="190" y2="80" stroke={color} strokeWidth="1.2" strokeDasharray="3 3" />
        <line x1="100" y1="126" x2="180" y2="190" stroke={color} strokeWidth="1.2" />
        <line x1="210" y1="100" x2="200" y2="180" stroke={color} strokeWidth="1.2" strokeDasharray="4 4" />
      </svg>
    )
  }
  ...
  if (type === 'enterprise') {
    return (
      <svg
        ...
        fill="none"
      >
        {/* Enterprise Multi-Tier Hexagonal Topology */}
        <polygon points="150,50 200,80 200,140 150,170 100,140 100,80" stroke={color} strokeWidth="1.5" fill="none" />
        <circle cx="150" cy="110" r="12" fill={color} />

        <polygon points="230,130 270,155 270,205 230,230 190,205 190,155" stroke={color} strokeWidth="1.2" fill="none" strokeDasharray="3 3" />
        <circle cx="230" cy="180" r="8" fill={color} />

        <polygon points="70,130 110,155 110,205 70,230 30,205 30,155" stroke={color} strokeWidth="1.2" fill="none" strokeDasharray="3 3" />
        <circle cx="70" cy="180" r="8" fill={color} />

        <line x1="150" y1="170" x2="70" y2="180" stroke={color} strokeWidth="1.2" />
        <line x1="150" y1="170" x2="230" y2="180" stroke={color} strokeWidth="1.2" />
      </svg>
    )
  }
...
const WhoIsItFor = () => {
  ...
  const handleSelect = (idx) => {
    ...
    if (isDesktop && !prefersReducedMotion) {
      const st = ScrollTrigger.getById('who-is-it-for-scroll')
      if (st) {
  ...
  return (
    <section
      ref={sectionRef}
      id="who-is-b2b-list-building-for"
      className="relative py-6 sm:py-8 lg:py-8 overflow-hidden bg-background"
      aria-label="Who Is B2B List Building For?"
    >
      {/* Background accents */}
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center mb-3.5 lg:mb-4">
          ...
          >
            B2B list building helps high-growth companies reach the right decision-makers with clean, verified prospect data.
          </motion.p>
        </div>
        ...
        >
          <div className="grid md:grid-cols-12 gap-5 lg:gap-6 items-stretch">
            {/* LEFT SIDE: Vertical Stack of 4 Selectable Audience Cards */}
                    ...
                    <div className="flex items-center justify-between gap-2 mb-1.5 pl-1.5">
                      ...
                      <span
                        className={`text-xs font-mono font-black tracking-widest transition-colors ${
                          isActive ? 'text-primary' : 'text-text-secondary/40'
                        }`}
