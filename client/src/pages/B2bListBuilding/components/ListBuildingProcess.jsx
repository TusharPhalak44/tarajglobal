...
import WorkflowCanvas from './ListBuildingProcessWorkflow/WorkflowCanvas'
import WorkflowMobileView from './ListBuildingProcessWorkflow/WorkflowMobileView'
import { WORKFLOW_STEPS } from './ListBuildingProcessWorkflow/workflowData'
...
const ListBuildingProcess = () => {
  ...
  return (
    <section
      ...
      aria-label="How Our B2B List Building Process Works"
    >
      ...
      <div className="relative max-w-[1380px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-5">
          ...
          {/* Main Title: B2B LIST BUILDING WORKFLOW */}
          <motion.div
          ...
          >
            A rigorous multi-tier research and validation pipeline delivering verified, campaign-ready B2B prospect intelligence.
          </motion.p>
        </div>
...
export default ListBuildingProcess
