...
export const trackPageView = async (req, res) => {
  try {
    const { page_url, referrer, user_agent, session_id, user_email } = req.body
    ...
    await db.execute(
      `INSERT INTO page_views (page_url, referrer, user_agent, session_id, ip_address, user_email) 
       VALUES (?, ?, ?, ?, ?, ?)`,
      [page_url, referrer || null, user_agent || null, session_id || null, ip_address, user_email || null]
    )
